...
apt-get install libboost-system${VERSION_BOOST}
apt-get install libboost-filesystem${VERSION_BOOST}
apt-get install libboost-thread${VERSION_BOOST}
apt-get install libboost-date-time${VERSION_BOOST}
apt-get install libboost-chrono${VERSION_BOOST}
apt-get install libboost-regex${VERSION_BOOST}
apt-get install libssl${VERSION_OPENSSL}
