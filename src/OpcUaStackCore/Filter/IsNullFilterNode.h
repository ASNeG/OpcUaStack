...
#ifndef __OpcUaStackCore_IsNullFilterNode_h__
#define __OpcUaStackCore_IsNullFilterNode_h__

#include "OpcUaStackCore/Filter/FilterNode.h"

namespace OpcUaStackCore
{
    class DLLEXPORT IsNullFilterNode
	: public FilterNode
    {
      public:

        typedef boost::shared_ptr<IsNullFilterNode> SPtr;

        IsNullFilterNode(const std::vector<FilterNode::SPtr>& args);
        virtual ~IsNullFilterNode(void);
