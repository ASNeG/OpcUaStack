...
#ifndef __OpcUaStackCore_NotFilterNode_h__
#define __OpcUaStackCore_NotFilterNode_h__

#include "OpcUaStackCore/Filter/FilterNode.h"

namespace OpcUaStackCore
{
    class DLLEXPORT NotFilterNode
	: public FilterNode
    {
      public:

        typedef boost::shared_ptr<NotFilterNode> SPtr;

        NotFilterNode(const std::vector<FilterNode::SPtr>& args);
        virtual ~NotFilterNode(void);
