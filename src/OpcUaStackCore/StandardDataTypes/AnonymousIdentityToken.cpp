...
namespace OpcUaStackCore
{
    ...
    bool
    AnonymousIdentityToken::jsonEncode(boost::property_tree::ptree& pt, const std::string& element)
    {
        boost::property_tree::ptree elementTree;
        if (!jsonEncode(elementTree)) {
    	     Log(Error, "AnonymousIdentityToken json encoder error")
    		     .parameter("Element", element);
     	     return false;
        }
        pt.push_back(std::make_pair(element, elementTree));
    ...
    bool
    AnonymousIdentityToken::jsonEncode(boost::property_tree::ptree& pt)
    {
        boost::property_tree::ptree elementTree;
    ...
    bool
    AnonymousIdentityToken::jsonDecode(boost::property_tree::ptree& pt, const std::string& element)
    {
        boost::optional<boost::property_tree::ptree&> tmpTree;
    
        tmpTree = pt.get_child_optional(element);
        if (!tmpTree) {
     	     Log(Error, "AnonymousIdentityToken json decoder error")
    		    .parameter("Element", element);
    		 return false;
        }
    ...
    bool
    AnonymousIdentityToken::jsonDecode(boost::property_tree::ptree& pt)
    {
        std::string elementName;
        boost::optional<boost::property_tree::ptree&> tree;
