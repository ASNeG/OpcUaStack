...
namespace OpcUaStackCore
{
    ...
    HistoryEvent::xmlEncode(boost::property_tree::ptree& pt, Xmlns& xmlns)
    {
        ...
        elementTree.clear();
        if (!events_.xmlEncode(elementTree, "HistoryEventFieldList", xmlns)) return false;
    ...
    HistoryEvent::xmlDecode(boost::property_tree::ptree& pt, Xmlns& xmlns)
    {
        ...
        if (!tree) return false;
        if (!events_.xmlDecode(*tree, "HistoryEventFieldList", xmlns)) return false;
    
        return true;
    }
    
    bool
    HistoryEvent::jsonEncode(boost::property_tree::ptree& pt, const std::string& element)
    {
        return true;
    }
    
    bool
    HistoryEvent::jsonEncode(boost::property_tree::ptree& pt)
    {
        return true;
    }
    
    bool
    HistoryEvent::jsonDecode(boost::property_tree::ptree& pt, const std::string& element)
    {
    }
    
    bool
    HistoryEvent::jsonDecode(boost::property_tree::ptree& pt)
    {
    }
