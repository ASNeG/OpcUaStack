...
namespace OpcUaStackCore
{
    ...
    bool
    SessionDiagnosticsDataType::encode(boost::property_tree::ptree& pt, Xmlns& xmlns) const
    {
    }
    
    bool
    SessionDiagnosticsDataType::decode(boost::property_tree::ptree& pt, Xmlns& xmlns)
    {
    }
