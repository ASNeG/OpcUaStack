...
namespace OpcUaStackCore
{
    ...
    SessionDiagnosticsDataType::jsonDecodeImpl(const boost::property_tree::ptree& pt)
    {
        ...
        rc = rc & jsonObjectDecode(pt, sessionName_, "SessionName");
        ...
        rc = rc & jsonObjectDecode(pt, clientLastContactTime_, "ClientLastContactTime");
        ...
        rc = rc & jsonObjectDecode(pt, totalRequestCount_, "TotalRequestCount");
        rc = rc & jsonNumberDecode(pt, unauthorizedRequestCount_, "UnauthorizedRequestCount");
        rc = rc & jsonObjectDecode(pt, readCount_, "ReadCount");
        rc = rc & jsonObjectDecode(pt, historyReadCount_, "HistoryReadCount");
        rc = rc & jsonObjectDecode(pt, writeCount_, "WriteCount");
        rc = rc & jsonObjectDecode(pt, historyUpdateCount_, "HistoryUpdateCount");
        rc = rc & jsonObjectDecode(pt, callCount_, "CallCount");
        rc = rc & jsonObjectDecode(pt, createMonitoredItemsCount_, "CreateMonitoredItemsCount");
        rc = rc & jsonObjectDecode(pt, modifyMonitoredItemsCount_, "ModifyMonitoredItemsCount");
        rc = rc & jsonObjectDecode(pt, setMonitoringModeCount_, "SetMonitoringModeCount");
        rc = rc & jsonObjectDecode(pt, setTriggeringCount_, "SetTriggeringCount");
        rc = rc & jsonObjectDecode(pt, deleteMonitoredItemsCount_, "DeleteMonitoredItemsCount");
        rc = rc & jsonObjectDecode(pt, createSubscriptionCount_, "CreateSubscriptionCount");
        rc = rc & jsonObjectDecode(pt, modifySubscriptionCount_, "ModifySubscriptionCount");
        rc = rc & jsonObjectDecode(pt, setPublishingModeCount_, "SetPublishingModeCount");
        rc = rc & jsonObjectDecode(pt, publishCount_, "PublishCount");
        rc = rc & jsonObjectDecode(pt, republishCount_, "RepublishCount");
        rc = rc & jsonObjectDecode(pt, transferSubscriptionsCount_, "TransferSubscriptionsCount");
        rc = rc & jsonObjectDecode(pt, deleteSubscriptionsCount_, "DeleteSubscriptionsCount");
        rc = rc & jsonObjectDecode(pt, addNodesCount_, "AddNodesCount");
        rc = rc & jsonObjectDecode(pt, addReferencesCount_, "AddReferencesCount");
        rc = rc & jsonObjectDecode(pt, deleteNodesCount_, "DeleteNodesCount");
        rc = rc & jsonObjectDecode(pt, deleteReferencesCount_, "DeleteReferencesCount");
        rc = rc & jsonObjectDecode(pt, browseCount_, "BrowseCount");
        rc = rc & jsonObjectDecode(pt, browseNextCount_, "BrowseNextCount");
        rc = rc & jsonObjectDecode(pt, translateBrowsePathsToNodeIdsCount_, "TranslateBrowsePathsToNodeIdsCount");
        rc = rc & jsonObjectDecode(pt, queryFirstCount_, "QueryFirstCount");
        rc = rc & jsonObjectDecode(pt, queryNextCount_, "QueryNextCount");
        rc = rc & jsonObjectDecode(pt, registerNodesCount_, "RegisterNodesCount");
        rc = rc & jsonObjectDecode(pt, unregisterNodesCount_, "UnregisterNodesCount");
