...
namespace OpcUaStackCore
{
    ...
    SessionDiagnosticsDataType::jsonEncodeImpl(boost::property_tree::ptree& pt) const
    {
        ...
        rc = rc & jsonObjectEncode(pt, sessionName_, "SessionName", true);
        rc = rc & jsonObjectEncode(pt, clientDescription_, "ClientDescription", true);
        ...
        rc = rc & jsonObjectEncode(pt, clientConnectionTime_, "ClientConnectionTime", true);
        rc = rc & jsonObjectEncode(pt, clientLastContactTime_, "ClientLastContactTime", true);
        ...
        rc = rc & jsonObjectEncode(pt, totalRequestCount_, "TotalRequestCount", true);
        rc = rc & jsonNumberEncode(pt, unauthorizedRequestCount_, "UnauthorizedRequestCount");
        rc = rc & jsonObjectEncode(pt, readCount_, "ReadCount", true);
        rc = rc & jsonObjectEncode(pt, historyReadCount_, "HistoryReadCount", true);
        rc = rc & jsonObjectEncode(pt, writeCount_, "WriteCount", true);
        rc = rc & jsonObjectEncode(pt, historyUpdateCount_, "HistoryUpdateCount", true);
        rc = rc & jsonObjectEncode(pt, callCount_, "CallCount", true);
        rc = rc & jsonObjectEncode(pt, createMonitoredItemsCount_, "CreateMonitoredItemsCount", true);
        rc = rc & jsonObjectEncode(pt, modifyMonitoredItemsCount_, "ModifyMonitoredItemsCount", true);
        rc = rc & jsonObjectEncode(pt, setMonitoringModeCount_, "SetMonitoringModeCount", true);
        rc = rc & jsonObjectEncode(pt, setTriggeringCount_, "SetTriggeringCount", true);
        rc = rc & jsonObjectEncode(pt, deleteMonitoredItemsCount_, "DeleteMonitoredItemsCount", true);
        rc = rc & jsonObjectEncode(pt, createSubscriptionCount_, "CreateSubscriptionCount", true);
        rc = rc & jsonObjectEncode(pt, modifySubscriptionCount_, "ModifySubscriptionCount", true);
        rc = rc & jsonObjectEncode(pt, setPublishingModeCount_, "SetPublishingModeCount", true);
        rc = rc & jsonObjectEncode(pt, publishCount_, "PublishCount", true);
        rc = rc & jsonObjectEncode(pt, republishCount_, "RepublishCount", true);
        rc = rc & jsonObjectEncode(pt, transferSubscriptionsCount_, "TransferSubscriptionsCount", true);
        rc = rc & jsonObjectEncode(pt, deleteSubscriptionsCount_, "DeleteSubscriptionsCount", true);
        rc = rc & jsonObjectEncode(pt, addNodesCount_, "AddNodesCount", true);
        rc = rc & jsonObjectEncode(pt, addReferencesCount_, "AddReferencesCount", true);
        rc = rc & jsonObjectEncode(pt, deleteNodesCount_, "DeleteNodesCount", true);
        rc = rc & jsonObjectEncode(pt, deleteReferencesCount_, "DeleteReferencesCount", true);
        rc = rc & jsonObjectEncode(pt, browseCount_, "BrowseCount", true);
        rc = rc & jsonObjectEncode(pt, browseNextCount_, "BrowseNextCount", true);
        rc = rc & jsonObjectEncode(pt, translateBrowsePathsToNodeIdsCount_, "TranslateBrowsePathsToNodeIdsCount", true);
        rc = rc & jsonObjectEncode(pt, queryFirstCount_, "QueryFirstCount", true);
        rc = rc & jsonObjectEncode(pt, queryNextCount_, "QueryNextCount", true);
        rc = rc & jsonObjectEncode(pt, registerNodesCount_, "RegisterNodesCount", true);
        rc = rc & jsonObjectEncode(pt, unregisterNodesCount_, "UnregisterNodesCount", true);
    ...
    SessionDiagnosticsDataType::jsonDecodeImpl(const boost::property_tree::ptree& pt)
    {
        ...
        rc = rc & jsonObjectDecode(pt, sessionName_, "SessionName", true);
        rc = rc & jsonObjectDecode(pt, clientDescription_, "ClientDescription", true);
        ...
        rc = rc & jsonObjectDecode(pt, clientConnectionTime_, "ClientConnectionTime", true);
        rc = rc & jsonObjectDecode(pt, clientLastContactTime_, "ClientLastContactTime", true);
        rc = rc & jsonNumberDecode(pt, currentSubscriptionsCount_, "CurrentSubscriptionsCount");
        rc = rc & jsonNumberDecode(pt, currentMonitoredItemsCount_, "CurrentMonitoredItemsCount");
        rc = rc & jsonNumberDecode(pt, currentPublishRequestsInQueue_, "CurrentPublishRequestsInQueue");
        rc = rc & jsonObjectDecode(pt, totalRequestCount_, "TotalRequestCount", true);
        rc = rc & jsonNumberDecode(pt, unauthorizedRequestCount_, "UnauthorizedRequestCount");
        rc = rc & jsonObjectDecode(pt, readCount_, "ReadCount", true);
        rc = rc & jsonObjectDecode(pt, historyReadCount_, "HistoryReadCount", true);
        rc = rc & jsonObjectDecode(pt, writeCount_, "WriteCount", true);
        rc = rc & jsonObjectDecode(pt, historyUpdateCount_, "HistoryUpdateCount", true);
        rc = rc & jsonObjectDecode(pt, callCount_, "CallCount", true);
        rc = rc & jsonObjectDecode(pt, createMonitoredItemsCount_, "CreateMonitoredItemsCount", true);
        rc = rc & jsonObjectDecode(pt, modifyMonitoredItemsCount_, "ModifyMonitoredItemsCount", true);
        rc = rc & jsonObjectDecode(pt, setMonitoringModeCount_, "SetMonitoringModeCount", true);
        rc = rc & jsonObjectDecode(pt, setTriggeringCount_, "SetTriggeringCount", true);
        rc = rc & jsonObjectDecode(pt, deleteMonitoredItemsCount_, "DeleteMonitoredItemsCount", true);
        rc = rc & jsonObjectDecode(pt, createSubscriptionCount_, "CreateSubscriptionCount", true);
        rc = rc & jsonObjectDecode(pt, modifySubscriptionCount_, "ModifySubscriptionCount", true);
        rc = rc & jsonObjectDecode(pt, setPublishingModeCount_, "SetPublishingModeCount", true);
        rc = rc & jsonObjectDecode(pt, publishCount_, "PublishCount", true);
        rc = rc & jsonObjectDecode(pt, republishCount_, "RepublishCount", true);
        rc = rc & jsonObjectDecode(pt, transferSubscriptionsCount_, "TransferSubscriptionsCount", true);
        rc = rc & jsonObjectDecode(pt, deleteSubscriptionsCount_, "DeleteSubscriptionsCount", true);
        rc = rc & jsonObjectDecode(pt, addNodesCount_, "AddNodesCount", true);
        rc = rc & jsonObjectDecode(pt, addReferencesCount_, "AddReferencesCount", true);
        rc = rc & jsonObjectDecode(pt, deleteNodesCount_, "DeleteNodesCount", true);
        rc = rc & jsonObjectDecode(pt, deleteReferencesCount_, "DeleteReferencesCount", true);
        rc = rc & jsonObjectDecode(pt, browseCount_, "BrowseCount", true);
        rc = rc & jsonObjectDecode(pt, browseNextCount_, "BrowseNextCount", true);
        rc = rc & jsonObjectDecode(pt, translateBrowsePathsToNodeIdsCount_, "TranslateBrowsePathsToNodeIdsCount", true);
        rc = rc & jsonObjectDecode(pt, queryFirstCount_, "QueryFirstCount", true);
        rc = rc & jsonObjectDecode(pt, queryNextCount_, "QueryNextCount", true);
        rc = rc & jsonObjectDecode(pt, registerNodesCount_, "RegisterNodesCount", true);
        rc = rc & jsonObjectDecode(pt, unregisterNodesCount_, "UnregisterNodesCount", true);
