...
#OpcUaDataTypeGenerator4 --nodeset Opc.Ua.NodeSet2.xml --datatype AggregateConfiguration --buildSubTypes 0
#OpcUaDataTypeGenerator4 --nodeset Opc.Ua.NodeSet2.xml --datatype Annotation --buildSubTypes 0
#OpcUaDataTypeGenerator4 --nodeset Opc.Ua.NodeSet2.xml --datatype ApplicationDescription --buildSubTypes 0
#OpcUaDataTypeGenerator4 --nodeset Opc.Ua.NodeSet2.xml --datatype Argument --buildSubTypes 0
#OpcUaDataTypeGenerator4 --nodeset Opc.Ua.NodeSet2.xml --datatype AxisInformation --buildSubTypes 0
