...
namespace OpcUaStackCore
{
    ...
    bool
    SecurityTokenRequestType::encode(boost::property_tree::ptree& pt, Xmlns& xmlns) const
    {
    }
    
    bool
    SecurityTokenRequestType::decode(boost::property_tree::ptree& pt, Xmlns& xmlns)
    {
    }
