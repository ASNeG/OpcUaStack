...
namespace OpcUaStackCore
{
    ...
    bool
    ReaderGroupTransportDataType::jsonEncode(boost::property_tree::ptree& pt, const std::string& element)
    {
        boost::property_tree::ptree elementTree;
        if (!jsonEncode(elementTree)) {
    	     Log(Error, "ReaderGroupTransportDataType json encoder error")
    		     .parameter("Element", element);
     	     return false;
        }
        pt.push_back(std::make_pair(element, elementTree));
    ...
    bool
    ReaderGroupTransportDataType::jsonEncode(boost::property_tree::ptree& pt)
    {
        boost::property_tree::ptree elementTree;
    ...
    bool
    ReaderGroupTransportDataType::jsonDecode(boost::property_tree::ptree& pt, const std::string& element)
    {
        boost::optional<boost::property_tree::ptree&> tmpTree;
    
        tmpTree = pt.get_child_optional(element);
        if (!tmpTree) {
     	     Log(Error, "ReaderGroupTransportDataType json decoder error")
    		    .parameter("Element", element);
    		 return false;
        }
    ...
    bool
    ReaderGroupTransportDataType::jsonDecode(boost::property_tree::ptree& pt)
    {
        std::string elementName;
        boost::optional<boost::property_tree::ptree&> tree;
