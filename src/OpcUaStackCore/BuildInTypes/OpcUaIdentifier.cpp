...
namespace OpcUaStackCore
{
	...
	OpcUaIdMap::initial(void)
	{
        ...
        insert("Node_Encoding_DefaultXml", 259);
        insert("InstanceNode_Encoding_DefaultXml", 11887);
        insert("TypeNode_Encoding_DefaultXml", 11888);
        insert("ObjectNode_Encoding_DefaultXml", 262);
        insert("ObjectTypeNode_Encoding_DefaultXml", 265);
        insert("VariableNode_Encoding_DefaultXml", 268);
        insert("VariableTypeNode_Encoding_DefaultXml", 271);
        insert("ReferenceTypeNode_Encoding_DefaultXml", 274);
        insert("MethodNode_Encoding_DefaultXml", 277);
        insert("ViewNode_Encoding_DefaultXml", 280);
        insert("DataTypeNode_Encoding_DefaultXml", 283);
        insert("ReferenceNode_Encoding_DefaultXml", 286);
        insert("Argument_Encoding_DefaultXml", 297);
        insert("EnumValueType_Encoding_DefaultXml", 7616);
        insert("TimeZoneDataType_Encoding_DefaultXml", 8913);
        insert("ApplicationDescription_Encoding_DefaultXml", 309);
        insert("RequestHeader_Encoding_DefaultXml", 390);
        insert("ResponseHeader_Encoding_DefaultXml", 393);
        insert("ServiceFault_Encoding_DefaultXml", 396);
        insert("FindServersRequest_Encoding_DefaultXml", 421);
        insert("FindServersResponse_Encoding_DefaultXml", 424);
        insert("UserTokenPolicy_Encoding_DefaultXml", 305);
        insert("EndpointDescription_Encoding_DefaultXml", 313);
        insert("GetEndpointsRequest_Encoding_DefaultXml", 427);
        insert("GetEndpointsResponse_Encoding_DefaultXml", 430);
        insert("RegisteredServer_Encoding_DefaultXml", 433);
        insert("RegisterServerRequest_Encoding_DefaultXml", 436);
        insert("RegisterServerResponse_Encoding_DefaultXml", 439);
        insert("ChannelSecurityToken_Encoding_DefaultXml", 442);
        insert("OpenSecureChannelRequest_Encoding_DefaultXml", 445);
        insert("OpenSecureChannelResponse_Encoding_DefaultXml", 448);
        insert("CloseSecureChannelRequest_Encoding_DefaultXml", 451);
        insert("CloseSecureChannelResponse_Encoding_DefaultXml", 454);
        insert("SignedSoftwareCertificate_Encoding_DefaultXml", 345);
        insert("SignatureData_Encoding_DefaultXml", 457);
        insert("CreateSessionRequest_Encoding_DefaultXml", 460);
        insert("CreateSessionResponse_Encoding_DefaultXml", 463);
        insert("UserIdentityToken_Encoding_DefaultXml", 317);
        insert("AnonymousIdentityToken_Encoding_DefaultXml", 320);
        insert("UserNameIdentityToken_Encoding_DefaultXml", 323);
        insert("X509IdentityToken_Encoding_DefaultXml", 326);
        insert("IssuedIdentityToken_Encoding_DefaultXml", 939);
        insert("ActivateSessionRequest_Encoding_DefaultXml", 466);
        insert("ActivateSessionResponse_Encoding_DefaultXml", 469);
        insert("CloseSessionRequest_Encoding_DefaultXml", 472);
        insert("CloseSessionResponse_Encoding_DefaultXml", 475);
        insert("CancelRequest_Encoding_DefaultXml", 478);
        insert("CancelResponse_Encoding_DefaultXml", 481);
        insert("NodeAttributes_Encoding_DefaultXml", 350);
        insert("ObjectAttributes_Encoding_DefaultXml", 353);
        insert("VariableAttributes_Encoding_DefaultXml", 356);
        insert("MethodAttributes_Encoding_DefaultXml", 359);
        insert("ObjectTypeAttributes_Encoding_DefaultXml", 362);
        insert("VariableTypeAttributes_Encoding_DefaultXml", 365);
        insert("ReferenceTypeAttributes_Encoding_DefaultXml", 368);
        insert("DataTypeAttributes_Encoding_DefaultXml", 371);
        insert("ViewAttributes_Encoding_DefaultXml", 374);
        insert("AddNodesItem_Encoding_DefaultXml", 377);
        insert("AddNodesResult_Encoding_DefaultXml", 484);
        insert("AddNodesRequest_Encoding_DefaultXml", 487);
        insert("AddNodesResponse_Encoding_DefaultXml", 490);
        insert("AddReferencesItem_Encoding_DefaultXml", 380);
        insert("AddReferencesRequest_Encoding_DefaultXml", 493);
        insert("AddReferencesResponse_Encoding_DefaultXml", 496);
        insert("DeleteNodesItem_Encoding_DefaultXml", 383);
        insert("DeleteNodesRequest_Encoding_DefaultXml", 499);
        insert("DeleteNodesResponse_Encoding_DefaultXml", 502);
        insert("DeleteReferencesItem_Encoding_DefaultXml", 386);
        insert("DeleteReferencesRequest_Encoding_DefaultXml", 505);
        insert("DeleteReferencesResponse_Encoding_DefaultXml", 508);
        insert("ViewDescription_Encoding_DefaultXml", 512);
        insert("BrowseDescription_Encoding_DefaultXml", 515);
        insert("ReferenceDescription_Encoding_DefaultXml", 519);
        insert("BrowseResult_Encoding_DefaultXml", 523);
        insert("BrowseRequest_Encoding_DefaultXml", 526);
        insert("BrowseResponse_Encoding_DefaultXml", 529);
        insert("BrowseNextRequest_Encoding_DefaultXml", 532);
        insert("BrowseNextResponse_Encoding_DefaultXml", 535);
        insert("RelativePathElement_Encoding_DefaultXml", 538);
        insert("RelativePath_Encoding_DefaultXml", 541);
        insert("BrowsePath_Encoding_DefaultXml", 544);
        insert("BrowsePathTarget_Encoding_DefaultXml", 547);
        insert("BrowsePathResult_Encoding_DefaultXml", 550);
        insert("TranslateBrowsePathsToNodeIdsRequest_Encoding_DefaultXml", 553);
        insert("TranslateBrowsePathsToNodeIdsResponse_Encoding_DefaultXml", 556);
        insert("RegisterNodesRequest_Encoding_DefaultXml", 559);
        insert("RegisterNodesResponse_Encoding_DefaultXml", 562);
        insert("UnregisterNodesRequest_Encoding_DefaultXml", 565);
        insert("UnregisterNodesResponse_Encoding_DefaultXml", 568);
        insert("EndpointConfiguration_Encoding_DefaultXml", 332);
        insert("SupportedProfile_Encoding_DefaultXml", 336);
        insert("SoftwareCertificate_Encoding_DefaultXml", 342);
        insert("QueryDataDescription_Encoding_DefaultXml", 571);
        insert("NodeTypeDescription_Encoding_DefaultXml", 574);
        insert("QueryDataSet_Encoding_DefaultXml", 578);
        insert("NodeReference_Encoding_DefaultXml", 581);
        insert("ContentFilterElement_Encoding_DefaultXml", 584);
        insert("ContentFilter_Encoding_DefaultXml", 587);
        insert("FilterOperand_Encoding_DefaultXml", 590);
        insert("ElementOperand_Encoding_DefaultXml", 593);
        insert("LiteralOperand_Encoding_DefaultXml", 596);
        insert("AttributeOperand_Encoding_DefaultXml", 599);
        insert("SimpleAttributeOperand_Encoding_DefaultXml", 602);
        insert("ContentFilterElementResult_Encoding_DefaultXml", 605);
        insert("ContentFilterResult_Encoding_DefaultXml", 608);
        insert("ParsingResult_Encoding_DefaultXml", 611);
        insert("QueryFirstRequest_Encoding_DefaultXml", 614);
        insert("QueryFirstResponse_Encoding_DefaultXml", 617);
        insert("QueryNextRequest_Encoding_DefaultXml", 620);
        insert("QueryNextResponse_Encoding_DefaultXml", 623);
        insert("ReadValueId_Encoding_DefaultXml", 627);
        insert("ReadRequest_Encoding_DefaultXml", 630);
        insert("ReadResponse_Encoding_DefaultXml", 633);
        insert("HistoryReadValueId_Encoding_DefaultXml", 636);
        insert("HistoryReadResult_Encoding_DefaultXml", 639);
        insert("HistoryReadDetails_Encoding_DefaultXml", 642);
        insert("ReadEventDetails_Encoding_DefaultXml", 645);
        insert("ReadRawModifiedDetails_Encoding_DefaultXml", 648);
        insert("ReadProcessedDetails_Encoding_DefaultXml", 651);
        insert("ReadAtTimeDetails_Encoding_DefaultXml", 654);
        insert("HistoryData_Encoding_DefaultXml", 657);
        insert("ModificationInfo_Encoding_DefaultXml", 11218);
        insert("HistoryModifiedData_Encoding_DefaultXml", 11219);
        insert("HistoryEvent_Encoding_DefaultXml", 660);
        insert("HistoryReadRequest_Encoding_DefaultXml", 663);
        insert("HistoryReadResponse_Encoding_DefaultXml", 666);
        insert("WriteValue_Encoding_DefaultXml", 669);
        insert("WriteRequest_Encoding_DefaultXml", 672);
        insert("WriteResponse_Encoding_DefaultXml", 675);
        insert("HistoryUpdateDetails_Encoding_DefaultXml", 678);
        insert("UpdateDataDetails_Encoding_DefaultXml", 681);
        insert("UpdateStructureDataDetails_Encoding_DefaultXml", 11296);
        insert("UpdateEventDetails_Encoding_DefaultXml", 684);
        insert("DeleteRawModifiedDetails_Encoding_DefaultXml", 687);
        insert("DeleteAtTimeDetails_Encoding_DefaultXml", 690);
        insert("DeleteEventDetails_Encoding_DefaultXml", 693);
        insert("HistoryUpdateResult_Encoding_DefaultXml", 696);
        insert("HistoryUpdateRequest_Encoding_DefaultXml", 699);
        insert("HistoryUpdateResponse_Encoding_DefaultXml", 702);
        insert("CallMethodRequest_Encoding_DefaultXml", 705);
        insert("CallMethodResult_Encoding_DefaultXml", 708);
        insert("CallRequest_Encoding_DefaultXml", 711);
        insert("CallResponse_Encoding_DefaultXml", 714);
        insert("MonitoringFilter_Encoding_DefaultXml", 720);
        insert("DataChangeFilter_Encoding_DefaultXml", 723);
        insert("EventFilter_Encoding_DefaultXml", 726);
        insert("AggregateConfiguration_Encoding_DefaultXml", 949);
        insert("AggregateFilter_Encoding_DefaultXml", 729);
        insert("MonitoringFilterResult_Encoding_DefaultXml", 732);
        insert("EventFilterResult_Encoding_DefaultXml", 735);
        insert("AggregateFilterResult_Encoding_DefaultXml", 738);
        insert("MonitoringParameters_Encoding_DefaultXml", 741);
        insert("MonitoredItemCreateRequest_Encoding_DefaultXml", 744);
        insert("MonitoredItemCreateResult_Encoding_DefaultXml", 747);
        insert("CreateMonitoredItemsRequest_Encoding_DefaultXml", 750);
        insert("CreateMonitoredItemsResponse_Encoding_DefaultXml", 753);
        insert("MonitoredItemModifyRequest_Encoding_DefaultXml", 756);
        insert("MonitoredItemModifyResult_Encoding_DefaultXml", 759);
        insert("ModifyMonitoredItemsRequest_Encoding_DefaultXml", 762);
        insert("ModifyMonitoredItemsResponse_Encoding_DefaultXml", 765);
        insert("SetMonitoringModeRequest_Encoding_DefaultXml", 768);
        insert("SetMonitoringModeResponse_Encoding_DefaultXml", 771);
        insert("SetTriggeringRequest_Encoding_DefaultXml", 774);
        insert("SetTriggeringResponse_Encoding_DefaultXml", 777);
        insert("DeleteMonitoredItemsRequest_Encoding_DefaultXml", 780);
        insert("DeleteMonitoredItemsResponse_Encoding_DefaultXml", 783);
        insert("CreateSubscriptionRequest_Encoding_DefaultXml", 786);
        insert("CreateSubscriptionResponse_Encoding_DefaultXml", 789);
        insert("ModifySubscriptionRequest_Encoding_DefaultXml", 792);
        insert("ModifySubscriptionResponse_Encoding_DefaultXml", 795);
        insert("SetPublishingModeRequest_Encoding_DefaultXml", 798);
        insert("SetPublishingModeResponse_Encoding_DefaultXml", 801);
        insert("NotificationMessage_Encoding_DefaultXml", 804);
        insert("NotificationData_Encoding_DefaultXml", 946);
        insert("DataChangeNotification_Encoding_DefaultXml", 810);
        insert("MonitoredItemNotification_Encoding_DefaultXml", 807);
        insert("EventNotificationList_Encoding_DefaultXml", 915);
        insert("EventFieldList_Encoding_DefaultXml", 918);
        insert("HistoryEventFieldList_Encoding_DefaultXml", 921);
        insert("StatusChangeNotification_Encoding_DefaultXml", 819);
        insert("SubscriptionAcknowledgement_Encoding_DefaultXml", 822);
        insert("PublishRequest_Encoding_DefaultXml", 825);
        insert("PublishResponse_Encoding_DefaultXml", 828);
        insert("RepublishRequest_Encoding_DefaultXml", 831);
        insert("RepublishResponse_Encoding_DefaultXml", 834);
        insert("TransferResult_Encoding_DefaultXml", 837);
        insert("TransferSubscriptionsRequest_Encoding_DefaultXml", 840);
        insert("TransferSubscriptionsResponse_Encoding_DefaultXml", 843);
        insert("DeleteSubscriptionsRequest_Encoding_DefaultXml", 846);
        insert("DeleteSubscriptionsResponse_Encoding_DefaultXml", 849);
        insert("ScalarTestType_Encoding_DefaultXml", 400);
        insert("ArrayTestType_Encoding_DefaultXml", 403);
        insert("CompositeTestType_Encoding_DefaultXml", 406);
        insert("TestStackRequest_Encoding_DefaultXml", 409);
        insert("TestStackResponse_Encoding_DefaultXml", 412);
        insert("TestStackExRequest_Encoding_DefaultXml", 415);
        insert("TestStackExResponse_Encoding_DefaultXml", 418);
        insert("BuildInfo_Encoding_DefaultXml", 339);
        insert("RedundantServerDataType_Encoding_DefaultXml", 854);
        insert("EndpointUrlListDataType_Encoding_DefaultXml", 11949);
        insert("NetworkGroupDataType_Encoding_DefaultXml", 11950);
        insert("SamplingIntervalDiagnosticsDataType_Encoding_DefaultXml", 857);
        insert("ServerDiagnosticsSummaryDataType_Encoding_DefaultXml", 860);
        insert("ServerStatusDataType_Encoding_DefaultXml", 863);
        insert("SessionDiagnosticsDataType_Encoding_DefaultXml", 866);
        insert("SessionSecurityDiagnosticsDataType_Encoding_DefaultXml", 869);
        insert("ServiceCounterDataType_Encoding_DefaultXml", 872);
        insert("StatusResult_Encoding_DefaultXml", 300);
        insert("SubscriptionDiagnosticsDataType_Encoding_DefaultXml", 875);
        insert("ModelChangeStructureDataType_Encoding_DefaultXml", 878);
        insert("SemanticChangeStructureDataType_Encoding_DefaultXml", 898);
        insert("Range_Encoding_DefaultXml", 885);
        insert("EUInformation_Encoding_DefaultXml", 888);
        insert("ComplexNumberType_Encoding_DefaultXml", 12173);
        insert("DoubleComplexNumberType_Encoding_DefaultXml", 12174);
        insert("AxisInformation_Encoding_DefaultXml", 12081);
        insert("XVType_Encoding_DefaultXml", 12082);
        insert("ProgramDiagnosticDataType_Encoding_DefaultXml", 895);
        insert("Annotation_Encoding_DefaultXml", 892);
        insert("Node_Encoding_DefaultBinary", 260);
        insert("InstanceNode_Encoding_DefaultBinary", 11889);
        insert("TypeNode_Encoding_DefaultBinary", 11890);
        insert("ObjectNode_Encoding_DefaultBinary", 263);
        insert("ObjectTypeNode_Encoding_DefaultBinary", 266);
        insert("VariableNode_Encoding_DefaultBinary", 269);
        insert("VariableTypeNode_Encoding_DefaultBinary", 272);
        insert("ReferenceTypeNode_Encoding_DefaultBinary", 275);
        insert("MethodNode_Encoding_DefaultBinary", 278);
        insert("ViewNode_Encoding_DefaultBinary", 281);
        insert("DataTypeNode_Encoding_DefaultBinary", 284);
        insert("ReferenceNode_Encoding_DefaultBinary", 287);
        insert("Argument_Encoding_DefaultBinary", 298);
        insert("EnumValueType_Encoding_DefaultBinary", 8251);
        insert("TimeZoneDataType_Encoding_DefaultBinary", 8917);
        insert("ApplicationDescription_Encoding_DefaultBinary", 310);
        insert("RequestHeader_Encoding_DefaultBinary", 391);
        insert("ResponseHeader_Encoding_DefaultBinary", 394);
        insert("ServiceFault_Encoding_DefaultBinary", 397);
        insert("FindServersRequest_Encoding_DefaultBinary", 422);
        insert("FindServersResponse_Encoding_DefaultBinary", 425);
        insert("UserTokenPolicy_Encoding_DefaultBinary", 306);
        insert("EndpointDescription_Encoding_DefaultBinary", 314);
        insert("GetEndpointsRequest_Encoding_DefaultBinary", 428);
        insert("GetEndpointsResponse_Encoding_DefaultBinary", 431);
        insert("RegisteredServer_Encoding_DefaultBinary", 434);
        insert("RegisterServerRequest_Encoding_DefaultBinary", 437);
        insert("RegisterServerResponse_Encoding_DefaultBinary", 440);
        insert("ChannelSecurityToken_Encoding_DefaultBinary", 443);
        insert("OpenSecureChannelRequest_Encoding_DefaultBinary", 446);
        insert("OpenSecureChannelResponse_Encoding_DefaultBinary", 449);
        insert("CloseSecureChannelRequest_Encoding_DefaultBinary", 452);
        insert("CloseSecureChannelResponse_Encoding_DefaultBinary", 455);
        insert("SignedSoftwareCertificate_Encoding_DefaultBinary", 346);
        insert("SignatureData_Encoding_DefaultBinary", 458);
        insert("CreateSessionRequest_Encoding_DefaultBinary", 461);
        insert("CreateSessionResponse_Encoding_DefaultBinary", 464);
        insert("UserIdentityToken_Encoding_DefaultBinary", 318);
        insert("AnonymousIdentityToken_Encoding_DefaultBinary", 321);
        insert("UserNameIdentityToken_Encoding_DefaultBinary", 324);
        insert("X509IdentityToken_Encoding_DefaultBinary", 327);
        insert("IssuedIdentityToken_Encoding_DefaultBinary", 940);
        insert("ActivateSessionRequest_Encoding_DefaultBinary", 467);
        insert("ActivateSessionResponse_Encoding_DefaultBinary", 470);
        insert("CloseSessionRequest_Encoding_DefaultBinary", 473);
        insert("CloseSessionResponse_Encoding_DefaultBinary", 476);
        insert("CancelRequest_Encoding_DefaultBinary", 479);
        insert("CancelResponse_Encoding_DefaultBinary", 482);
        insert("NodeAttributes_Encoding_DefaultBinary", 351);
        insert("ObjectAttributes_Encoding_DefaultBinary", 354);
        insert("VariableAttributes_Encoding_DefaultBinary", 357);
        insert("MethodAttributes_Encoding_DefaultBinary", 360);
        insert("ObjectTypeAttributes_Encoding_DefaultBinary", 363);
        insert("VariableTypeAttributes_Encoding_DefaultBinary", 366);
        insert("ReferenceTypeAttributes_Encoding_DefaultBinary", 369);
        insert("DataTypeAttributes_Encoding_DefaultBinary", 372);
        insert("ViewAttributes_Encoding_DefaultBinary", 375);
        insert("AddNodesItem_Encoding_DefaultBinary", 378);
        insert("AddNodesResult_Encoding_DefaultBinary", 485);
        insert("AddNodesRequest_Encoding_DefaultBinary", 488);
        insert("AddNodesResponse_Encoding_DefaultBinary", 491);
        insert("AddReferencesItem_Encoding_DefaultBinary", 381);
        insert("AddReferencesRequest_Encoding_DefaultBinary", 494);
        insert("AddReferencesResponse_Encoding_DefaultBinary", 497);
        insert("DeleteNodesItem_Encoding_DefaultBinary", 384);
        insert("DeleteNodesRequest_Encoding_DefaultBinary", 500);
        insert("DeleteNodesResponse_Encoding_DefaultBinary", 503);
        insert("DeleteReferencesItem_Encoding_DefaultBinary", 387);
        insert("DeleteReferencesRequest_Encoding_DefaultBinary", 506);
        insert("DeleteReferencesResponse_Encoding_DefaultBinary", 509);
        insert("ViewDescription_Encoding_DefaultBinary", 513);
        insert("BrowseDescription_Encoding_DefaultBinary", 516);
        insert("ReferenceDescription_Encoding_DefaultBinary", 520);
        insert("BrowseResult_Encoding_DefaultBinary", 524);
        insert("BrowseRequest_Encoding_DefaultBinary", 527);
        insert("BrowseResponse_Encoding_DefaultBinary", 530);
        insert("BrowseNextRequest_Encoding_DefaultBinary", 533);
        insert("BrowseNextResponse_Encoding_DefaultBinary", 536);
        insert("RelativePathElement_Encoding_DefaultBinary", 539);
        insert("RelativePath_Encoding_DefaultBinary", 542);
        insert("BrowsePath_Encoding_DefaultBinary", 545);
        insert("BrowsePathTarget_Encoding_DefaultBinary", 548);
        insert("BrowsePathResult_Encoding_DefaultBinary", 551);
        insert("TranslateBrowsePathsToNodeIdsRequest_Encoding_DefaultBinary", 554);
        insert("TranslateBrowsePathsToNodeIdsResponse_Encoding_DefaultBinary", 557);
        insert("RegisterNodesRequest_Encoding_DefaultBinary", 560);
        insert("RegisterNodesResponse_Encoding_DefaultBinary", 563);
        insert("UnregisterNodesRequest_Encoding_DefaultBinary", 566);
        insert("UnregisterNodesResponse_Encoding_DefaultBinary", 569);
        insert("EndpointConfiguration_Encoding_DefaultBinary", 333);
        insert("SupportedProfile_Encoding_DefaultBinary", 337);
        insert("SoftwareCertificate_Encoding_DefaultBinary", 343);
        insert("QueryDataDescription_Encoding_DefaultBinary", 572);
        insert("NodeTypeDescription_Encoding_DefaultBinary", 575);
        insert("QueryDataSet_Encoding_DefaultBinary", 579);
        insert("NodeReference_Encoding_DefaultBinary", 582);
        insert("ContentFilterElement_Encoding_DefaultBinary", 585);
        insert("ContentFilter_Encoding_DefaultBinary", 588);
        insert("FilterOperand_Encoding_DefaultBinary", 591);
        insert("ElementOperand_Encoding_DefaultBinary", 594);
        insert("LiteralOperand_Encoding_DefaultBinary", 597);
        insert("AttributeOperand_Encoding_DefaultBinary", 600);
        insert("SimpleAttributeOperand_Encoding_DefaultBinary", 603);
        insert("ContentFilterElementResult_Encoding_DefaultBinary", 606);
        insert("ContentFilterResult_Encoding_DefaultBinary", 609);
        insert("ParsingResult_Encoding_DefaultBinary", 612);
        insert("QueryFirstRequest_Encoding_DefaultBinary", 615);
        insert("QueryFirstResponse_Encoding_DefaultBinary", 618);
        insert("QueryNextRequest_Encoding_DefaultBinary", 621);
        insert("QueryNextResponse_Encoding_DefaultBinary", 624);
        insert("ReadValueId_Encoding_DefaultBinary", 628);
        insert("ReadRequest_Encoding_DefaultBinary", 631);
        insert("ReadResponse_Encoding_DefaultBinary", 634);
        insert("HistoryReadValueId_Encoding_DefaultBinary", 637);
        insert("HistoryReadResult_Encoding_DefaultBinary", 640);
        insert("HistoryReadDetails_Encoding_DefaultBinary", 643);
        insert("ReadEventDetails_Encoding_DefaultBinary", 646);
        insert("ReadRawModifiedDetails_Encoding_DefaultBinary", 649);
        insert("ReadProcessedDetails_Encoding_DefaultBinary", 652);
        insert("ReadAtTimeDetails_Encoding_DefaultBinary", 655);
        insert("HistoryData_Encoding_DefaultBinary", 658);
        insert("ModificationInfo_Encoding_DefaultBinary", 11226);
        insert("HistoryModifiedData_Encoding_DefaultBinary", 11227);
        insert("HistoryEvent_Encoding_DefaultBinary", 661);
        insert("HistoryReadRequest_Encoding_DefaultBinary", 664);
        insert("HistoryReadResponse_Encoding_DefaultBinary", 667);
        insert("WriteValue_Encoding_DefaultBinary", 670);
        insert("WriteRequest_Encoding_DefaultBinary", 673);
        insert("WriteResponse_Encoding_DefaultBinary", 676);
        insert("HistoryUpdateDetails_Encoding_DefaultBinary", 679);
        insert("UpdateDataDetails_Encoding_DefaultBinary", 682);
        insert("UpdateStructureDataDetails_Encoding_DefaultBinary", 11300);
        insert("UpdateEventDetails_Encoding_DefaultBinary", 685);
        insert("DeleteRawModifiedDetails_Encoding_DefaultBinary", 688);
        insert("DeleteAtTimeDetails_Encoding_DefaultBinary", 691);
        insert("DeleteEventDetails_Encoding_DefaultBinary", 694);
        insert("HistoryUpdateResult_Encoding_DefaultBinary", 697);
        insert("HistoryUpdateRequest_Encoding_DefaultBinary", 700);
        insert("HistoryUpdateResponse_Encoding_DefaultBinary", 703);
        insert("CallMethodRequest_Encoding_DefaultBinary", 706);
        insert("CallMethodResult_Encoding_DefaultBinary", 709);
        insert("CallRequest_Encoding_DefaultBinary", 712);
        insert("CallResponse_Encoding_DefaultBinary", 715);
        insert("MonitoringFilter_Encoding_DefaultBinary", 721);
        insert("DataChangeFilter_Encoding_DefaultBinary", 724);
        insert("EventFilter_Encoding_DefaultBinary", 727);
        insert("AggregateConfiguration_Encoding_DefaultBinary", 950);
        insert("AggregateFilter_Encoding_DefaultBinary", 730);
        insert("MonitoringFilterResult_Encoding_DefaultBinary", 733);
        insert("EventFilterResult_Encoding_DefaultBinary", 736);
        insert("AggregateFilterResult_Encoding_DefaultBinary", 739);
        insert("MonitoringParameters_Encoding_DefaultBinary", 742);
        insert("MonitoredItemCreateRequest_Encoding_DefaultBinary", 745);
        insert("MonitoredItemCreateResult_Encoding_DefaultBinary", 748);
        insert("CreateMonitoredItemsRequest_Encoding_DefaultBinary", 751);
        insert("CreateMonitoredItemsResponse_Encoding_DefaultBinary", 754);
        insert("MonitoredItemModifyRequest_Encoding_DefaultBinary", 757);
        insert("MonitoredItemModifyResult_Encoding_DefaultBinary", 760);
        insert("ModifyMonitoredItemsRequest_Encoding_DefaultBinary", 763);
        insert("ModifyMonitoredItemsResponse_Encoding_DefaultBinary", 766);
        insert("SetMonitoringModeRequest_Encoding_DefaultBinary", 769);
        insert("SetMonitoringModeResponse_Encoding_DefaultBinary", 772);
        insert("SetTriggeringRequest_Encoding_DefaultBinary", 775);
        insert("SetTriggeringResponse_Encoding_DefaultBinary", 778);
        insert("DeleteMonitoredItemsRequest_Encoding_DefaultBinary", 781);
        insert("DeleteMonitoredItemsResponse_Encoding_DefaultBinary", 784);
        insert("CreateSubscriptionRequest_Encoding_DefaultBinary", 787);
        insert("CreateSubscriptionResponse_Encoding_DefaultBinary", 790);
        insert("ModifySubscriptionRequest_Encoding_DefaultBinary", 793);
        insert("ModifySubscriptionResponse_Encoding_DefaultBinary", 796);
        insert("SetPublishingModeRequest_Encoding_DefaultBinary", 799);
        insert("SetPublishingModeResponse_Encoding_DefaultBinary", 802);
        insert("NotificationMessage_Encoding_DefaultBinary", 805);
        insert("NotificationData_Encoding_DefaultBinary", 947);
        insert("DataChangeNotification_Encoding_DefaultBinary", 811);
        insert("MonitoredItemNotification_Encoding_DefaultBinary", 808);
        insert("EventNotificationList_Encoding_DefaultBinary", 916);
        insert("EventFieldList_Encoding_DefaultBinary", 919);
        insert("HistoryEventFieldList_Encoding_DefaultBinary", 922);
        insert("StatusChangeNotification_Encoding_DefaultBinary", 820);
        insert("SubscriptionAcknowledgement_Encoding_DefaultBinary", 823);
        insert("PublishRequest_Encoding_DefaultBinary", 826);
        insert("PublishResponse_Encoding_DefaultBinary", 829);
        insert("RepublishRequest_Encoding_DefaultBinary", 832);
        insert("RepublishResponse_Encoding_DefaultBinary", 835);
        insert("TransferResult_Encoding_DefaultBinary", 838);
        insert("TransferSubscriptionsRequest_Encoding_DefaultBinary", 841);
        insert("TransferSubscriptionsResponse_Encoding_DefaultBinary", 844);
        insert("DeleteSubscriptionsRequest_Encoding_DefaultBinary", 847);
        insert("DeleteSubscriptionsResponse_Encoding_DefaultBinary", 850);
        insert("ScalarTestType_Encoding_DefaultBinary", 401);
        insert("ArrayTestType_Encoding_DefaultBinary", 404);
        insert("CompositeTestType_Encoding_DefaultBinary", 407);
        insert("TestStackRequest_Encoding_DefaultBinary", 410);
        insert("TestStackResponse_Encoding_DefaultBinary", 413);
        insert("TestStackExRequest_Encoding_DefaultBinary", 416);
        insert("TestStackExResponse_Encoding_DefaultBinary", 419);
        insert("BuildInfo_Encoding_DefaultBinary", 340);
        insert("RedundantServerDataType_Encoding_DefaultBinary", 855);
        insert("EndpointUrlListDataType_Encoding_DefaultBinary", 11957);
        insert("NetworkGroupDataType_Encoding_DefaultBinary", 11958);
        insert("SamplingIntervalDiagnosticsDataType_Encoding_DefaultBinary", 858);
        insert("ServerDiagnosticsSummaryDataType_Encoding_DefaultBinary", 861);
        insert("ServerStatusDataType_Encoding_DefaultBinary", 864);
        insert("SessionDiagnosticsDataType_Encoding_DefaultBinary", 867);
        insert("SessionSecurityDiagnosticsDataType_Encoding_DefaultBinary", 870);
        insert("ServiceCounterDataType_Encoding_DefaultBinary", 873);
        insert("StatusResult_Encoding_DefaultBinary", 301);
        insert("SubscriptionDiagnosticsDataType_Encoding_DefaultBinary", 876);
        insert("ModelChangeStructureDataType_Encoding_DefaultBinary", 879);
        insert("SemanticChangeStructureDataType_Encoding_DefaultBinary", 899);
        insert("Range_Encoding_DefaultBinary", 886);
        insert("EUInformation_Encoding_DefaultBinary", 889);
        insert("ComplexNumberType_Encoding_DefaultBinary", 12181);
        insert("DoubleComplexNumberType_Encoding_DefaultBinary", 12182);
        insert("AxisInformation_Encoding_DefaultBinary", 12089);
        insert("XVType_Encoding_DefaultBinary", 12090);
        insert("ProgramDiagnosticDataType_Encoding_DefaultBinary", 896);
        insert("Annotation_Encoding_DefaultBinary", 893);
...
// private identifier
//
        insert("RegisterForwardRequest_Encoding_DefaultBinary", 1000000);
        insert("RegisterForwardResponse_Encoding_DefaultBinary", 1000001);
        insert("GetNodeReferenceRequest_Encoding_DefaultBinary", 1000002);
        insert("GetNodeReferenceResponse_Encoding_DefaultBinary", 1000003);
        insert("NamespaceInfoRequest_Encoding_DefaultBinary", 1000004);
        insert("NamespaceInfoResponse_Encoding_DefaultBinary", 1000005);
	}
};
