...
namespace OpcUaStackCore
{
	...
	: public Object
	{
	  public:
	    ...
	    OpcUaDataValue(void);
	    OpcUaDataValue(const OpcUaNullValue& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaBoolean& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaByte& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaSByte& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaInt16& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaUInt16& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaInt32& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaUInt32& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaInt64& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaUInt64& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaString& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaDateTime& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaGuid& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaByteString& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaXmlElement& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaNodeId& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaExpandedNodeId& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaStatusCode& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaQualifiedName& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaLocalizedText& value, OpcUaStatusCode statusCode = Success);
	    OpcUaDataValue(const OpcUaExtensionObject& value, OpcUaStatusCode statusCode = Success);
		~OpcUaDataValue(void);
