...
#ifndef __OpcUaStackCore_RegisterForwardCallRequest_h__
#define __OpcUaStackCore_RegisterForwardCallRequest_h__
...
namespace OpcUaStackCore
{
	...
	class DLLEXPORT RegisterForwardCallRequest
	: public  Object
	{
	  public:
		typedef boost::shared_ptr<RegisterForwardCallRequest> SPtr;

		RegisterForwardCallRequest(void);
		virtual ~RegisterForwardCallRequest(void);
