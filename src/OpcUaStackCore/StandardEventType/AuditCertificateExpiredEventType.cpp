...
#include "OpcUaStackCore/StandardEventType/AuditCertificateExpiredEventType.h"
...
namespace OpcUaStackCore
{
    ...
    , eventVariables_()
    {
        ...
        eventVariables_.eventType(OpcUaNodeId((OpcUaUInt32)2085));
        eventVariables_.namespaceIndex(0);
        eventVariables_.browseName(OpcUaQualifiedName("AuditCertificateExpiredEventType"));
    ...
    OpcUaVariant::SPtr 
    AuditCertificateExpiredEventType::getAuditCertificateExpiredEventType(void)
    {
    ...
    bool 
    AuditCertificateExpiredEventType::setAuditCertificateExpiredEventType(OpcUaVariant::SPtr& value)
    {
    	return eventVariables_.setValue("EMPTY", value);
    }
    
    void
    AuditCertificateExpiredEventType::mapNamespaceUri(void)
    {
    ...
    OpcUaVariant::SPtr
    AuditCertificateExpiredEventType::get(
