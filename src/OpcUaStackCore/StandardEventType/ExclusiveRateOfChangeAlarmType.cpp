...
#include "OpcUaStackCore/StandardEventType/ExclusiveRateOfChangeAlarmType.h"
...
namespace OpcUaStackCore
{
    ...
    , eventVariables_()
    {
        ...
        eventVariables_.browseName(OpcUaQualifiedName("ExclusiveRateOfChangeAlarmType"));
    ...
    void
    ExclusiveRateOfChangeAlarmType::mapNamespaceUri(void)
    {
    ...
    OpcUaVariant::SPtr
    ExclusiveRateOfChangeAlarmType::get(
