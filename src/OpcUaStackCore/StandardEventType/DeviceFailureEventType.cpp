...
#include "OpcUaStackCore/StandardEventType/DeviceFailureEventType.h"
...
namespace OpcUaStackCore
{
    ...
    , eventVariables_()
    {
        ...
        eventVariables_.eventType(OpcUaNodeId((OpcUaUInt32)2131));
        eventVariables_.namespaceIndex(0);
        eventVariables_.browseName(OpcUaQualifiedName("DeviceFailureEventType"));
    ...
    OpcUaVariant::SPtr 
    DeviceFailureEventType::getDeviceFailureEventType(void)
    {
    ...
    bool 
    DeviceFailureEventType::setDeviceFailureEventType(OpcUaVariant::SPtr& value)
    {
    	return eventVariables_.setValue("EMPTY", value);
    }
    
    void
    DeviceFailureEventType::mapNamespaceUri(void)
    {
