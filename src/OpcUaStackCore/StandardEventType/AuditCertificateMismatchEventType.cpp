...
#include "OpcUaStackCore/StandardEventType/AuditCertificateMismatchEventType.h"
...
namespace OpcUaStackCore
{
    ...
    , eventVariables_()
    {
        ...
        eventVariables_.eventType(OpcUaNodeId((OpcUaUInt32)2089));
        eventVariables_.namespaceIndex(0);
        eventVariables_.browseName(OpcUaQualifiedName("AuditCertificateMismatchEventType"));
    ...
    OpcUaVariant::SPtr 
    AuditCertificateMismatchEventType::getAuditCertificateMismatchEventType(void)
    {
    ...
    bool 
    AuditCertificateMismatchEventType::setAuditCertificateMismatchEventType(OpcUaVariant::SPtr& value)
    {
    	return eventVariables_.setValue("EMPTY", value);
    }
    
    void
    AuditCertificateMismatchEventType::mapNamespaceUri(void)
    {
    ...
    OpcUaVariant::SPtr
    AuditCertificateMismatchEventType::get(
