...
#include "OpcUaStackCore/StandardEventType/AuditCertificateInvalidEventType.h"
...
namespace OpcUaStackCore
{
    ...
    , eventVariables_()
    {
        ...
        eventVariables_.eventType(OpcUaNodeId((OpcUaUInt32)2086));
        eventVariables_.namespaceIndex(0);
        eventVariables_.browseName(OpcUaQualifiedName("AuditCertificateInvalidEventType"));
    ...
    OpcUaVariant::SPtr 
    AuditCertificateInvalidEventType::getAuditCertificateInvalidEventType(void)
    {
    ...
    bool 
    AuditCertificateInvalidEventType::setAuditCertificateInvalidEventType(OpcUaVariant::SPtr& value)
    {
    	return eventVariables_.setValue("EMPTY", value);
    }
    
    void
    AuditCertificateInvalidEventType::mapNamespaceUri(void)
    {
    ...
    OpcUaVariant::SPtr
    AuditCertificateInvalidEventType::get(
