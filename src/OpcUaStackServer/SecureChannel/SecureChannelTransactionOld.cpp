...
namespace OpcUaStackServer
{
	...
	SecureChannelTransactionOld::SecureChannelTransactionOld(void)
	: channelId_(0)
	...
	void
	SecureChannelTransactionOld::isAppend(boost::asio::streambuf& sb)
	{
	...
	void
	SecureChannelTransactionOld::osAppend(boost::asio::streambuf& sb)
	{
