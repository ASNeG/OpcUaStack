   ...
   : public VariableBase
   {
     public:
       ...
       virtual ~CubeItemType(void);
        ...
        bool get_ZAxisDefinition_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ZAxisDefinition_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
