...
namespace OpcUaStackServer
{
    ...
    , lastMethodInputValues_Variable_(constructSPtr<ServerVariable>("LastMethodInputValues_Variable"))
    , lastMethodOutputArguments_Variable_(constructSPtr<ServerVariable>("LastMethodOutputArguments_Variable"))
    , lastMethodOutputValues_Variable_(constructSPtr<ServerVariable>("LastMethodOutputValues_Variable"))
