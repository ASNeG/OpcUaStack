   ...
   : public VariableBase
   {
     public:
       ...
       virtual ~NDimensionArrayItemType(void);
        ...
        bool get_AxisDefinition_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_AxisDefinition_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
