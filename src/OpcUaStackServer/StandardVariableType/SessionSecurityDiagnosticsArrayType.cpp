...
namespace OpcUaStackServer
{
    ...
    : VariableBase()
    , sessionSecurityDiagnostics_AuthenticationMechanism_Variable_(constructSPtr<ServerVariable>("SessionSecurityDiagnostics_AuthenticationMechanism_Variable"))
    , sessionSecurityDiagnostics_ClientCertificate_Variable_(constructSPtr<ServerVariable>("SessionSecurityDiagnostics_ClientCertificate_Variable"))
    , sessionSecurityDiagnostics_ClientUserIdHistory_Variable_(constructSPtr<ServerVariable>("SessionSecurityDiagnostics_ClientUserIdHistory_Variable"))
    , sessionSecurityDiagnostics_ClientUserIdOfSession_Variable_(constructSPtr<ServerVariable>("SessionSecurityDiagnostics_ClientUserIdOfSession_Variable"))
    , sessionSecurityDiagnostics_Encoding_Variable_(constructSPtr<ServerVariable>("SessionSecurityDiagnostics_Encoding_Variable"))
    , sessionSecurityDiagnostics_SecurityMode_Variable_(constructSPtr<ServerVariable>("SessionSecurityDiagnostics_SecurityMode_Variable"))
    , sessionSecurityDiagnostics_SecurityPolicyUri_Variable_(constructSPtr<ServerVariable>("SessionSecurityDiagnostics_SecurityPolicyUri_Variable"))
    , sessionSecurityDiagnostics_SessionId_Variable_(constructSPtr<ServerVariable>("SessionSecurityDiagnostics_SessionId_Variable"))
    , sessionSecurityDiagnostics_TransportProtocol_Variable_(constructSPtr<ServerVariable>("SessionSecurityDiagnostics_TransportProtocol_Variable"))
    , sessionSecurityDiagnostics_Variable_(constructSPtr<ServerVariable>("SessionSecurityDiagnostics_Variable"))
