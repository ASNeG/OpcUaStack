...
#ifndef __OpcUaStackServer_EUItemType_h__
#define __OpcUaStackServer_EUItemType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT EUItemType
   : public VariableBase
   {
     public:
       typedef boost::shared_ptr<EUItemType> SPtr;
       typedef std::vector<EUItemType::SPtr> Vec;
   
       EUItemType(void);
       EUItemType(const EUItemType& value);
       virtual ~EUItemType(void);
