...
namespace OpcUaStackServer
{
    ...
    : VariableBase()
    , actualSessionTimeout_Variable_(boost::make_shared<ServerVariable>("ActualSessionTimeout_Variable"))
    , addNodesCount_Variable_(boost::make_shared<ServerVariable>("AddNodesCount_Variable"))
    , addReferencesCount_Variable_(boost::make_shared<ServerVariable>("AddReferencesCount_Variable"))
    , browseCount_Variable_(boost::make_shared<ServerVariable>("BrowseCount_Variable"))
    , browseNextCount_Variable_(boost::make_shared<ServerVariable>("BrowseNextCount_Variable"))
    , callCount_Variable_(boost::make_shared<ServerVariable>("CallCount_Variable"))
    , clientConnectionTime_Variable_(boost::make_shared<ServerVariable>("ClientConnectionTime_Variable"))
    , clientDescription_Variable_(boost::make_shared<ServerVariable>("ClientDescription_Variable"))
    , clientLastContactTime_Variable_(boost::make_shared<ServerVariable>("ClientLastContactTime_Variable"))
    , createMonitoredItemsCount_Variable_(boost::make_shared<ServerVariable>("CreateMonitoredItemsCount_Variable"))
    , createSubscriptionCount_Variable_(boost::make_shared<ServerVariable>("CreateSubscriptionCount_Variable"))
    , currentMonitoredItemsCount_Variable_(boost::make_shared<ServerVariable>("CurrentMonitoredItemsCount_Variable"))
    , currentPublishRequestsInQueue_Variable_(boost::make_shared<ServerVariable>("CurrentPublishRequestsInQueue_Variable"))
    , currentSubscriptionsCount_Variable_(boost::make_shared<ServerVariable>("CurrentSubscriptionsCount_Variable"))
    , deleteMonitoredItemsCount_Variable_(boost::make_shared<ServerVariable>("DeleteMonitoredItemsCount_Variable"))
    , deleteNodesCount_Variable_(boost::make_shared<ServerVariable>("DeleteNodesCount_Variable"))
    , deleteReferencesCount_Variable_(boost::make_shared<ServerVariable>("DeleteReferencesCount_Variable"))
    , deleteSubscriptionsCount_Variable_(boost::make_shared<ServerVariable>("DeleteSubscriptionsCount_Variable"))
    , endpointUrl_Variable_(boost::make_shared<ServerVariable>("EndpointUrl_Variable"))
    , historyReadCount_Variable_(boost::make_shared<ServerVariable>("HistoryReadCount_Variable"))
    , historyUpdateCount_Variable_(boost::make_shared<ServerVariable>("HistoryUpdateCount_Variable"))
    , localeIds_Variable_(boost::make_shared<ServerVariable>("LocaleIds_Variable"))
    , maxResponseMessageSize_Variable_(boost::make_shared<ServerVariable>("MaxResponseMessageSize_Variable"))
    , modifyMonitoredItemsCount_Variable_(boost::make_shared<ServerVariable>("ModifyMonitoredItemsCount_Variable"))
    , modifySubscriptionCount_Variable_(boost::make_shared<ServerVariable>("ModifySubscriptionCount_Variable"))
    , publishCount_Variable_(boost::make_shared<ServerVariable>("PublishCount_Variable"))
    , queryFirstCount_Variable_(boost::make_shared<ServerVariable>("QueryFirstCount_Variable"))
    , queryNextCount_Variable_(boost::make_shared<ServerVariable>("QueryNextCount_Variable"))
    , readCount_Variable_(boost::make_shared<ServerVariable>("ReadCount_Variable"))
    , registerNodesCount_Variable_(boost::make_shared<ServerVariable>("RegisterNodesCount_Variable"))
    , republishCount_Variable_(boost::make_shared<ServerVariable>("RepublishCount_Variable"))
    , serverUri_Variable_(boost::make_shared<ServerVariable>("ServerUri_Variable"))
    , sessionId_Variable_(boost::make_shared<ServerVariable>("SessionId_Variable"))
    , sessionName_Variable_(boost::make_shared<ServerVariable>("SessionName_Variable"))
    , setMonitoringModeCount_Variable_(boost::make_shared<ServerVariable>("SetMonitoringModeCount_Variable"))
    , setPublishingModeCount_Variable_(boost::make_shared<ServerVariable>("SetPublishingModeCount_Variable"))
    , setTriggeringCount_Variable_(boost::make_shared<ServerVariable>("SetTriggeringCount_Variable"))
    , totalRequestCount_Variable_(boost::make_shared<ServerVariable>("TotalRequestCount_Variable"))
    , transferSubscriptionsCount_Variable_(boost::make_shared<ServerVariable>("TransferSubscriptionsCount_Variable"))
    , translateBrowsePathsToNodeIdsCount_Variable_(boost::make_shared<ServerVariable>("TranslateBrowsePathsToNodeIdsCount_Variable"))
    , unauthorizedRequestCount_Variable_(boost::make_shared<ServerVariable>("UnauthorizedRequestCount_Variable"))
    , unregisterNodesCount_Variable_(boost::make_shared<ServerVariable>("UnregisterNodesCount_Variable"))
    , variable_(boost::make_shared<ServerVariable>("Variable"))
    , writeCount_Variable_(boost::make_shared<ServerVariable>("WriteCount_Variable"))
    {
