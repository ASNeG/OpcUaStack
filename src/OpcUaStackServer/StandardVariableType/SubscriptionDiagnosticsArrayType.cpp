...
namespace OpcUaStackServer
{
    ...
    : VariableBase()
    , subscriptionDiagnostics_CurrentKeepAliveCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_CurrentKeepAliveCount_Variable"))
    , subscriptionDiagnostics_CurrentLifetimeCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_CurrentLifetimeCount_Variable"))
    , subscriptionDiagnostics_DataChangeNotificationsCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_DataChangeNotificationsCount_Variable"))
    , subscriptionDiagnostics_DisableCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_DisableCount_Variable"))
    , subscriptionDiagnostics_DisabledMonitoredItemCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_DisabledMonitoredItemCount_Variable"))
    , subscriptionDiagnostics_DiscardedMessageCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_DiscardedMessageCount_Variable"))
    , subscriptionDiagnostics_EnableCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_EnableCount_Variable"))
    , subscriptionDiagnostics_EventNotificationsCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_EventNotificationsCount_Variable"))
    , subscriptionDiagnostics_EventQueueOverflowCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_EventQueueOverflowCount_Variable"))
    , subscriptionDiagnostics_LatePublishRequestCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_LatePublishRequestCount_Variable"))
    , subscriptionDiagnostics_MaxKeepAliveCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_MaxKeepAliveCount_Variable"))
    , subscriptionDiagnostics_MaxLifetimeCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_MaxLifetimeCount_Variable"))
    , subscriptionDiagnostics_MaxNotificationsPerPublish_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_MaxNotificationsPerPublish_Variable"))
    , subscriptionDiagnostics_ModifyCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_ModifyCount_Variable"))
    , subscriptionDiagnostics_MonitoredItemCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_MonitoredItemCount_Variable"))
    , subscriptionDiagnostics_MonitoringQueueOverflowCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_MonitoringQueueOverflowCount_Variable"))
    , subscriptionDiagnostics_NextSequenceNumber_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_NextSequenceNumber_Variable"))
    , subscriptionDiagnostics_NotificationsCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_NotificationsCount_Variable"))
    , subscriptionDiagnostics_Priority_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_Priority_Variable"))
    , subscriptionDiagnostics_PublishRequestCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_PublishRequestCount_Variable"))
    , subscriptionDiagnostics_PublishingEnabled_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_PublishingEnabled_Variable"))
    , subscriptionDiagnostics_PublishingInterval_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_PublishingInterval_Variable"))
    , subscriptionDiagnostics_RepublishMessageCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_RepublishMessageCount_Variable"))
    , subscriptionDiagnostics_RepublishMessageRequestCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_RepublishMessageRequestCount_Variable"))
    , subscriptionDiagnostics_RepublishRequestCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_RepublishRequestCount_Variable"))
    , subscriptionDiagnostics_SessionId_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_SessionId_Variable"))
    , subscriptionDiagnostics_SubscriptionId_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_SubscriptionId_Variable"))
    , subscriptionDiagnostics_TransferRequestCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_TransferRequestCount_Variable"))
    , subscriptionDiagnostics_TransferredToAltClientCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_TransferredToAltClientCount_Variable"))
    , subscriptionDiagnostics_TransferredToSameClientCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_TransferredToSameClientCount_Variable"))
    , subscriptionDiagnostics_UnacknowledgedMessageCount_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_UnacknowledgedMessageCount_Variable"))
    , subscriptionDiagnostics_Variable_(boost::make_shared<ServerVariable>("SubscriptionDiagnostics_Variable"))
