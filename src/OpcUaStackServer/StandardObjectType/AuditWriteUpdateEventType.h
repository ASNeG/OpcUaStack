   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~AuditWriteUpdateEventType(void);
        ...
        bool get_AttributeId_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_AttributeId_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_IndexRange_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_IndexRange_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_NewValue_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_NewValue_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_OldValue_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_OldValue_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
