/*
    ObjectTypeClass: KeyCredentialDeletedAuditEventType
...
#ifndef __OpcUaStackServer_KeyCredentialDeletedAuditEventType_h__
#define __OpcUaStackServer_KeyCredentialDeletedAuditEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT KeyCredentialDeletedAuditEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<KeyCredentialDeletedAuditEventType> SPtr;
       typedef std::vector<KeyCredentialDeletedAuditEventType::SPtr> Vec;
   
       KeyCredentialDeletedAuditEventType(void);
       KeyCredentialDeletedAuditEventType(const KeyCredentialDeletedAuditEventType& value);
       virtual ~KeyCredentialDeletedAuditEventType(void);
