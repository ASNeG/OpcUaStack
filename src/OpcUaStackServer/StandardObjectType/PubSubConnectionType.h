   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~PubSubConnectionType(void);
        ...
        bool get_Address_NetworkInterface_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_Address_NetworkInterface_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_ConnectionProperties_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ConnectionProperties_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_Diagnostics_LiveValues_ResolvedAddress_DiagnosticsLevel_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_Diagnostics_LiveValues_ResolvedAddress_DiagnosticsLevel_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_Diagnostics_LiveValues_ResolvedAddress_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_Diagnostics_LiveValues_ResolvedAddress_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_TransportProfileUri_Selections_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_TransportProfileUri_Selections_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_TransportProfileUri_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_TransportProfileUri_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);

        virtual void call_AddReaderGroup_Method(OpcUaStackCore::ApplicationMethodContext* applicationMethodContext);

        virtual void call_AddWriterGroup_Method(OpcUaStackCore::ApplicationMethodContext* applicationMethodContext);

        virtual void call_Diagnostics_Reset_Method(OpcUaStackCore::ApplicationMethodContext* applicationMethodContext);

        virtual void call_RemoveGroup_Method(OpcUaStackCore::ApplicationMethodContext* applicationMethodContext);
