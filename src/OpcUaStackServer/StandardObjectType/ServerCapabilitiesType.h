   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~ServerCapabilitiesType(void);
        ...
        bool get_LocaleIdArray_Variable(OpcUaDataValue& dataValue);
        bool set_LocaleIdArray_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_MaxArrayLength_Variable(OpcUaDataValue& dataValue);
        bool set_MaxArrayLength_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_MaxBrowseContinuationPoints_Variable(OpcUaDataValue& dataValue);
        bool set_MaxBrowseContinuationPoints_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_MaxByteStringLength_Variable(OpcUaDataValue& dataValue);
        bool set_MaxByteStringLength_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_MaxHistoryContinuationPoints_Variable(OpcUaDataValue& dataValue);
        bool set_MaxHistoryContinuationPoints_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_MaxQueryContinuationPoints_Variable(OpcUaDataValue& dataValue);
        bool set_MaxQueryContinuationPoints_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_MaxStringLength_Variable(OpcUaDataValue& dataValue);
        bool set_MaxStringLength_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_MinSupportedSampleRate_Variable(OpcUaDataValue& dataValue);
        bool set_MinSupportedSampleRate_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_ServerProfileArray_Variable(OpcUaDataValue& dataValue);
        bool set_ServerProfileArray_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_SoftwareCertificates_Variable(OpcUaDataValue& dataValue);
        bool set_SoftwareCertificates_Variable(const OpcUaDataValue& dataValue);

        virtual void call_RoleSet_AddRole_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_RoleSet_RemoveRole_Method(ApplicationMethodContext* applicationMethodContext);
