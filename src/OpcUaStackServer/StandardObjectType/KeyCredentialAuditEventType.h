/*
    ObjectTypeClass: KeyCredentialAuditEventType
...
#ifndef __OpcUaStackServer_KeyCredentialAuditEventType_h__
#define __OpcUaStackServer_KeyCredentialAuditEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT KeyCredentialAuditEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<KeyCredentialAuditEventType> SPtr;
       typedef std::vector<KeyCredentialAuditEventType::SPtr> Vec;
   
       KeyCredentialAuditEventType(void);
       KeyCredentialAuditEventType(const KeyCredentialAuditEventType& value);
       virtual ~KeyCredentialAuditEventType(void);
