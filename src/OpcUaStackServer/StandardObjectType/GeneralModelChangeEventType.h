/*
    ObjectTypeClass: GeneralModelChangeEventType
...
#ifndef __OpcUaStackServer_GeneralModelChangeEventType_h__
#define __OpcUaStackServer_GeneralModelChangeEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT GeneralModelChangeEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<GeneralModelChangeEventType> SPtr;
       typedef std::vector<GeneralModelChangeEventType::SPtr> Vec;
   
       GeneralModelChangeEventType(void);
       GeneralModelChangeEventType(const GeneralModelChangeEventType& value);
       virtual ~GeneralModelChangeEventType(void);

        //
        // ModelChangeStructureDataType (Array)
        //
        void changes_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& changes_Variable(void);
        bool get_Changes_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_Changes_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ServerVariable::SPtr changes_Variable_;
