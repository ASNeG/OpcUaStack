/*
    ObjectTypeClass: BaseModelChangeEventType
...
#ifndef __OpcUaStackServer_BaseModelChangeEventType_h__
#define __OpcUaStackServer_BaseModelChangeEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<BaseModelChangeEventType::SPtr> Vec;
   
       BaseModelChangeEventType(void);
       BaseModelChangeEventType(const BaseModelChangeEventType& value);
