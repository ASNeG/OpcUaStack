/*
    ObjectTypeClass: AuditProgramTransitionEventType
...
#ifndef __OpcUaStackServer_AuditProgramTransitionEventType_h__
#define __OpcUaStackServer_AuditProgramTransitionEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditProgramTransitionEventType::SPtr> Vec;
   
       AuditProgramTransitionEventType(void);
       AuditProgramTransitionEventType(const AuditProgramTransitionEventType& value);
