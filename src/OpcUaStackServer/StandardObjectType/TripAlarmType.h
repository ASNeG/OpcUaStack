...
#ifndef __OpcUaStackServer_TripAlarmType_h__
#define __OpcUaStackServer_TripAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT TripAlarmType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<TripAlarmType> SPtr;
       typedef std::vector<TripAlarmType::SPtr> Vec;
   
       TripAlarmType(void);
       TripAlarmType(const TripAlarmType& value);
