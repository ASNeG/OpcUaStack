/*
    ObjectTypeClass: AuditChannelEventType
...
#ifndef __OpcUaStackServer_AuditChannelEventType_h__
#define __OpcUaStackServer_AuditChannelEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditChannelEventType::SPtr> Vec;
   
       AuditChannelEventType(void);
       AuditChannelEventType(const AuditChannelEventType& value);
