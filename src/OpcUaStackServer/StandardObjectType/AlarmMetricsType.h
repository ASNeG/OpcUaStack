   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~AlarmMetricsType(void);
        ...
        bool get_AlarmCount_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_AlarmCount_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_AverageAlarmRate_Rate_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_AverageAlarmRate_Rate_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_AverageAlarmRate_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_AverageAlarmRate_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_CurrentAlarmRate_Rate_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_CurrentAlarmRate_Rate_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_CurrentAlarmRate_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_CurrentAlarmRate_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_MaximumActiveState_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_MaximumActiveState_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_MaximumAlarmRate_Rate_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_MaximumAlarmRate_Rate_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_MaximumAlarmRate_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_MaximumAlarmRate_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_MaximumReAlarmCount_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_MaximumReAlarmCount_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_MaximumUnAck_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_MaximumUnAck_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
