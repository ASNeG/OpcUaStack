...
namespace OpcUaStackServer
{
    ...
    , securityGroups_RemoveSecurityGroup_Method_(boost::make_shared<ServerMethod>("SecurityGroups_RemoveSecurityGroup_Method"))
    {
        ...
        getSecurityGroup_Method_->registerMethod(boost::bind(&PubSubKeyServiceType::call_GetSecurityGroup_Method, this, _1));
        getSecurityKeys_Method_->registerMethod(boost::bind(&PubSubKeyServiceType::call_GetSecurityKeys_Method, this, _1));
        securityGroups_AddSecurityGroup_Method_->registerMethod(boost::bind(&PubSubKeyServiceType::call_SecurityGroups_AddSecurityGroup_Method, this, _1));
        securityGroups_RemoveSecurityGroup_Method_->registerMethod(boost::bind(&PubSubKeyServiceType::call_SecurityGroups_RemoveSecurityGroup_Method, this, _1));
    }
