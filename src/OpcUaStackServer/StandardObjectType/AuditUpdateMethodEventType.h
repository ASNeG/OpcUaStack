/*
    ObjectTypeClass: AuditUpdateMethodEventType
...
#ifndef __OpcUaStackServer_AuditUpdateMethodEventType_h__
#define __OpcUaStackServer_AuditUpdateMethodEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditUpdateMethodEventType::SPtr> Vec;
   
       AuditUpdateMethodEventType(void);
       AuditUpdateMethodEventType(const AuditUpdateMethodEventType& value);
