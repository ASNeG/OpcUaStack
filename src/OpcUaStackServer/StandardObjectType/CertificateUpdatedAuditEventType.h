/*
    ObjectTypeClass: CertificateUpdatedAuditEventType
...
#ifndef __OpcUaStackServer_CertificateUpdatedAuditEventType_h__
#define __OpcUaStackServer_CertificateUpdatedAuditEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT CertificateUpdatedAuditEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<CertificateUpdatedAuditEventType> SPtr;
       typedef std::vector<CertificateUpdatedAuditEventType::SPtr> Vec;
   
       CertificateUpdatedAuditEventType(void);
       CertificateUpdatedAuditEventType(const CertificateUpdatedAuditEventType& value);
       virtual ~CertificateUpdatedAuditEventType(void);
        ...
        // NodeId
        //
        void certificateGroup_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& certificateGroup_Variable(void);
        bool get_CertificateGroup_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_CertificateGroup_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr certificateGroup_Variable_;
