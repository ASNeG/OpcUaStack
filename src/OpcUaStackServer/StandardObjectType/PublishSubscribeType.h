   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~PublishSubscribeType(void);
        ...
        bool get_SupportedTransportProfiles_Variable(OpcUaDataValue& dataValue);
        bool set_SupportedTransportProfiles_Variable(const OpcUaDataValue& dataValue);

        virtual void call_AddConnection_Method(ApplicationMethodContext* applicationMethodContext);
        ...
        virtual void call_RemoveConnection_Method(ApplicationMethodContext* applicationMethodContext);
        ...
        virtual void call_SetSecurityKeys_Method(ApplicationMethodContext* applicationMethodContext);
