/*
    ObjectTypeClass: AuditCreateSessionEventType
...
#ifndef __OpcUaStackServer_AuditCreateSessionEventType_h__
#define __OpcUaStackServer_AuditCreateSessionEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditCreateSessionEventType::SPtr> Vec;
   
       AuditCreateSessionEventType(void);
       AuditCreateSessionEventType(const AuditCreateSessionEventType& value);
       virtual ~AuditCreateSessionEventType(void);
        ...
        bool get_RevisedSessionTimeout_Variable(OpcUaDataValue& dataValue);
        bool set_RevisedSessionTimeout_Variable(const OpcUaDataValue& dataValue);
