/*
    ObjectTypeClass: AuditUpdateEventType
...
#ifndef __OpcUaStackServer_AuditUpdateEventType_h__
#define __OpcUaStackServer_AuditUpdateEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditUpdateEventType::SPtr> Vec;
   
       AuditUpdateEventType(void);
       AuditUpdateEventType(const AuditUpdateEventType& value);
