   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~AuditActivateSessionEventType(void);
        ...
        bool get_ClientSoftwareCertificates_Variable(OpcUaDataValue& dataValue);
        bool set_ClientSoftwareCertificates_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_UserIdentityToken_Variable(OpcUaDataValue& dataValue);
        bool set_UserIdentityToken_Variable(const OpcUaDataValue& dataValue);
