/*
    ObjectTypeClass: RefreshRequiredEventType
...
#ifndef __OpcUaStackServer_RefreshRequiredEventType_h__
#define __OpcUaStackServer_RefreshRequiredEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<RefreshRequiredEventType::SPtr> Vec;
   
       RefreshRequiredEventType(void);
       RefreshRequiredEventType(const RefreshRequiredEventType& value);
