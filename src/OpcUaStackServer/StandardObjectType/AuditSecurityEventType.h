/*
    ObjectTypeClass: AuditSecurityEventType
...
#ifndef __OpcUaStackServer_AuditSecurityEventType_h__
#define __OpcUaStackServer_AuditSecurityEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditSecurityEventType::SPtr> Vec;
   
       AuditSecurityEventType(void);
       AuditSecurityEventType(const AuditSecurityEventType& value);
