/*
    ObjectTypeClass: AuditEventType
...
#ifndef __OpcUaStackServer_AuditEventType_h__
#define __OpcUaStackServer_AuditEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditEventType::SPtr> Vec;
   
       AuditEventType(void);
       AuditEventType(const AuditEventType& value);
