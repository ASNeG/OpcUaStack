...
#ifndef __OpcUaStackServer_BaseEventType_h__
#define __OpcUaStackServer_BaseEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<BaseEventType::SPtr> Vec;
   
       BaseEventType(void);
       BaseEventType(const BaseEventType& value);
