/*
    ObjectTypeClass: SystemDiagnosticAlarmType
...
#ifndef __OpcUaStackServer_SystemDiagnosticAlarmType_h__
#define __OpcUaStackServer_SystemDiagnosticAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT SystemDiagnosticAlarmType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<SystemDiagnosticAlarmType> SPtr;
       typedef std::vector<SystemDiagnosticAlarmType::SPtr> Vec;
   
       SystemDiagnosticAlarmType(void);
       SystemDiagnosticAlarmType(const SystemDiagnosticAlarmType& value);
       virtual ~SystemDiagnosticAlarmType(void);
