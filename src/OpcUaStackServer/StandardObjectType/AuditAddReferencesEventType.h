/*
    ObjectTypeClass: AuditAddReferencesEventType
...
#ifndef __OpcUaStackServer_AuditAddReferencesEventType_h__
#define __OpcUaStackServer_AuditAddReferencesEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT AuditAddReferencesEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<AuditAddReferencesEventType> SPtr;
       typedef std::vector<AuditAddReferencesEventType::SPtr> Vec;
   
       AuditAddReferencesEventType(void);
       AuditAddReferencesEventType(const AuditAddReferencesEventType& value);
       virtual ~AuditAddReferencesEventType(void);
        ...
        //
        // AddReferencesItem (Array)
        //
        void referencesToAdd_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& referencesToAdd_Variable(void);
        bool get_ReferencesToAdd_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ReferencesToAdd_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr referencesToAdd_Variable_;
