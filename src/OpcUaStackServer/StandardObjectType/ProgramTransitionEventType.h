   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~ProgramTransitionEventType(void);
        ...
        bool get_IntermediateResult_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_IntermediateResult_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
