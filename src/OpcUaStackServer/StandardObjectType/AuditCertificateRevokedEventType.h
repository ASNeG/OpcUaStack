/*
    ObjectTypeClass: AuditCertificateRevokedEventType
...
#ifndef __OpcUaStackServer_AuditCertificateRevokedEventType_h__
#define __OpcUaStackServer_AuditCertificateRevokedEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT AuditCertificateRevokedEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<AuditCertificateRevokedEventType> SPtr;
       typedef std::vector<AuditCertificateRevokedEventType::SPtr> Vec;
   
       AuditCertificateRevokedEventType(void);
       AuditCertificateRevokedEventType(const AuditCertificateRevokedEventType& value);
