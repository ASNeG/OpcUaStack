/*
    ObjectTypeClass: AuditConditionSilenceEventType
...
#ifndef __OpcUaStackServer_AuditConditionSilenceEventType_h__
#define __OpcUaStackServer_AuditConditionSilenceEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT AuditConditionSilenceEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<AuditConditionSilenceEventType> SPtr;
       typedef std::vector<AuditConditionSilenceEventType::SPtr> Vec;
   
       AuditConditionSilenceEventType(void);
       AuditConditionSilenceEventType(const AuditConditionSilenceEventType& value);
       virtual ~AuditConditionSilenceEventType(void);
