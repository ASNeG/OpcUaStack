/*
    ObjectTypeClass: SystemStatusChangeEventType
...
#ifndef __OpcUaStackServer_SystemStatusChangeEventType_h__
#define __OpcUaStackServer_SystemStatusChangeEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT SystemStatusChangeEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<SystemStatusChangeEventType> SPtr;
       typedef std::vector<SystemStatusChangeEventType::SPtr> Vec;
   
       SystemStatusChangeEventType(void);
       SystemStatusChangeEventType(const SystemStatusChangeEventType& value);
       virtual ~SystemStatusChangeEventType(void);
        ...
        // ServerState
        //
        void systemState_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& systemState_Variable(void);
        bool get_SystemState_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_SystemState_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr systemState_Variable_;
