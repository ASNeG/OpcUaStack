/*
    ObjectTypeClass: RoleMappingRuleChangedAuditEventType
...
#ifndef __OpcUaStackServer_RoleMappingRuleChangedAuditEventType_h__
#define __OpcUaStackServer_RoleMappingRuleChangedAuditEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT RoleMappingRuleChangedAuditEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<RoleMappingRuleChangedAuditEventType> SPtr;
       typedef std::vector<RoleMappingRuleChangedAuditEventType::SPtr> Vec;
   
       RoleMappingRuleChangedAuditEventType(void);
       RoleMappingRuleChangedAuditEventType(const RoleMappingRuleChangedAuditEventType& value);
       virtual ~RoleMappingRuleChangedAuditEventType(void);
