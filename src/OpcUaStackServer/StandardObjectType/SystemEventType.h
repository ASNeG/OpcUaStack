/*
    ObjectTypeClass: SystemEventType
...
#ifndef __OpcUaStackServer_SystemEventType_h__
#define __OpcUaStackServer_SystemEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT SystemEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<SystemEventType> SPtr;
       typedef std::vector<SystemEventType::SPtr> Vec;
   
       SystemEventType(void);
       SystemEventType(const SystemEventType& value);
