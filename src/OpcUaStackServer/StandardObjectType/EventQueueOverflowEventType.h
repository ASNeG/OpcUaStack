/*
    ObjectTypeClass: EventQueueOverflowEventType
...
#ifndef __OpcUaStackServer_EventQueueOverflowEventType_h__
#define __OpcUaStackServer_EventQueueOverflowEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<EventQueueOverflowEventType::SPtr> Vec;
   
       EventQueueOverflowEventType(void);
       EventQueueOverflowEventType(const EventQueueOverflowEventType& value);
