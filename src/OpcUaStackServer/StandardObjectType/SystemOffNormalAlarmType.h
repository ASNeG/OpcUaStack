/*
    ObjectTypeClass: SystemOffNormalAlarmType
...
#ifndef __OpcUaStackServer_SystemOffNormalAlarmType_h__
#define __OpcUaStackServer_SystemOffNormalAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<SystemOffNormalAlarmType::SPtr> Vec;
   
       SystemOffNormalAlarmType(void);
       SystemOffNormalAlarmType(const SystemOffNormalAlarmType& value);
