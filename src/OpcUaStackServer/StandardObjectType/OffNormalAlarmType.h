/*
    ObjectTypeClass: OffNormalAlarmType
...
#ifndef __OpcUaStackServer_OffNormalAlarmType_h__
#define __OpcUaStackServer_OffNormalAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<OffNormalAlarmType::SPtr> Vec;
   
       OffNormalAlarmType(void);
       OffNormalAlarmType(const OffNormalAlarmType& value);
