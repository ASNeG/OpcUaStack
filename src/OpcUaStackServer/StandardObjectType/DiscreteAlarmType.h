/*
    ObjectTypeClass: DiscreteAlarmType
...
#ifndef __OpcUaStackServer_DiscreteAlarmType_h__
#define __OpcUaStackServer_DiscreteAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<DiscreteAlarmType::SPtr> Vec;
   
       DiscreteAlarmType(void);
       DiscreteAlarmType(const DiscreteAlarmType& value);
