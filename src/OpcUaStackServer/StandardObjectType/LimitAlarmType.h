/*
    ObjectTypeClass: LimitAlarmType
...
#ifndef __OpcUaStackServer_LimitAlarmType_h__
#define __OpcUaStackServer_LimitAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<LimitAlarmType::SPtr> Vec;
   
       LimitAlarmType(void);
       LimitAlarmType(const LimitAlarmType& value);
