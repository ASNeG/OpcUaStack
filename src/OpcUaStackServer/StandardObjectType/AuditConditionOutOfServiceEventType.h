/*
    ObjectTypeClass: AuditConditionOutOfServiceEventType
...
#ifndef __OpcUaStackServer_AuditConditionOutOfServiceEventType_h__
#define __OpcUaStackServer_AuditConditionOutOfServiceEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT AuditConditionOutOfServiceEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<AuditConditionOutOfServiceEventType> SPtr;
       typedef std::vector<AuditConditionOutOfServiceEventType::SPtr> Vec;
   
       AuditConditionOutOfServiceEventType(void);
       AuditConditionOutOfServiceEventType(const AuditConditionOutOfServiceEventType& value);
       virtual ~AuditConditionOutOfServiceEventType(void);
