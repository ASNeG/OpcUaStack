/*
    ObjectTypeClass: ExclusiveLevelAlarmType
...
#ifndef __OpcUaStackServer_ExclusiveLevelAlarmType_h__
#define __OpcUaStackServer_ExclusiveLevelAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<ExclusiveLevelAlarmType::SPtr> Vec;
   
       ExclusiveLevelAlarmType(void);
       ExclusiveLevelAlarmType(const ExclusiveLevelAlarmType& value);
