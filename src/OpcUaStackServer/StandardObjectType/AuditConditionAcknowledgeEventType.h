/*
    ObjectTypeClass: AuditConditionAcknowledgeEventType
...
#ifndef __OpcUaStackServer_AuditConditionAcknowledgeEventType_h__
#define __OpcUaStackServer_AuditConditionAcknowledgeEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditConditionAcknowledgeEventType::SPtr> Vec;
   
       AuditConditionAcknowledgeEventType(void);
       AuditConditionAcknowledgeEventType(const AuditConditionAcknowledgeEventType& value);
       virtual ~AuditConditionAcknowledgeEventType(void);
        ...
        bool get_ConditionEventId_Variable(OpcUaDataValue& dataValue);
        bool set_ConditionEventId_Variable(const OpcUaDataValue& dataValue);
