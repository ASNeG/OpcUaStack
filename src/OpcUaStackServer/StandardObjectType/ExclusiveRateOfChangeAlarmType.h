/*
    ObjectTypeClass: ExclusiveRateOfChangeAlarmType
...
#ifndef __OpcUaStackServer_ExclusiveRateOfChangeAlarmType_h__
#define __OpcUaStackServer_ExclusiveRateOfChangeAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<ExclusiveRateOfChangeAlarmType::SPtr> Vec;
   
       ExclusiveRateOfChangeAlarmType(void);
       ExclusiveRateOfChangeAlarmType(const ExclusiveRateOfChangeAlarmType& value);
