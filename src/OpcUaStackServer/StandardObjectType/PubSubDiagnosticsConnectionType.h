   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~PubSubDiagnosticsConnectionType(void);
        ...
        bool get_LiveValues_ResolvedAddress_DiagnosticsLevel_Variable(OpcUaDataValue& dataValue);
        bool set_LiveValues_ResolvedAddress_DiagnosticsLevel_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_LiveValues_ResolvedAddress_Variable(OpcUaDataValue& dataValue);
        bool set_LiveValues_ResolvedAddress_Variable(const OpcUaDataValue& dataValue);
