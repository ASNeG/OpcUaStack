/*
    ObjectTypeClass: DeviceFailureEventType
...
#ifndef __OpcUaStackServer_DeviceFailureEventType_h__
#define __OpcUaStackServer_DeviceFailureEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<DeviceFailureEventType::SPtr> Vec;
   
       DeviceFailureEventType(void);
       DeviceFailureEventType(const DeviceFailureEventType& value);
