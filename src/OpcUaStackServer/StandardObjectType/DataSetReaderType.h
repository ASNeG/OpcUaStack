   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~DataSetReaderType(void);
        ...
        bool get_DataSetReaderProperties_Variable(OpcUaDataValue& dataValue);
        bool set_DataSetReaderProperties_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_SubscribedDataSet_DataSetMetaData_Variable(OpcUaDataValue& dataValue);
        bool set_SubscribedDataSet_DataSetMetaData_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_SubscribedDataSet_MessageReceiveTimeout_Variable(OpcUaDataValue& dataValue);
        bool set_SubscribedDataSet_MessageReceiveTimeout_Variable(const OpcUaDataValue& dataValue);
        ...
        virtual void call_CreateDataSetMirror_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_CreateTargetVariables_Method(ApplicationMethodContext* applicationMethodContext);
