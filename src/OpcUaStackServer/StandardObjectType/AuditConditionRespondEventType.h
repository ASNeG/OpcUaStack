/*
    ObjectTypeClass: AuditConditionRespondEventType
...
#ifndef __OpcUaStackServer_AuditConditionRespondEventType_h__
#define __OpcUaStackServer_AuditConditionRespondEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditConditionRespondEventType::SPtr> Vec;
   
       AuditConditionRespondEventType(void);
       AuditConditionRespondEventType(const AuditConditionRespondEventType& value);
       virtual ~AuditConditionRespondEventType(void);
        ...
        // Int32
        //
        void selectedResponse_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& selectedResponse_Variable(void);
        bool get_SelectedResponse_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_SelectedResponse_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr selectedResponse_Variable_;
