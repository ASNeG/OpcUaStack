/*
    ObjectTypeClass: AlarmConditionType
...
#ifndef __OpcUaStackServer_AlarmConditionType_h__
#define __OpcUaStackServer_AlarmConditionType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AlarmConditionType::SPtr> Vec;
   
       AlarmConditionType(void);
       AlarmConditionType(const AlarmConditionType& value);
