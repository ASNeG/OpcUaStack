/*
    ObjectTypeClass: AuditHistoryUpdateEventType
...
#ifndef __OpcUaStackServer_AuditHistoryUpdateEventType_h__
#define __OpcUaStackServer_AuditHistoryUpdateEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditHistoryUpdateEventType::SPtr> Vec;
   
       AuditHistoryUpdateEventType(void);
       AuditHistoryUpdateEventType(const AuditHistoryUpdateEventType& value);
