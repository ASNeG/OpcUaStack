/*
    ObjectTypeClass: PubSubCommunicationFailureEventType
...
#ifndef __OpcUaStackServer_PubSubCommunicationFailureEventType_h__
#define __OpcUaStackServer_PubSubCommunicationFailureEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT PubSubCommunicationFailureEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<PubSubCommunicationFailureEventType> SPtr;
       typedef std::vector<PubSubCommunicationFailureEventType::SPtr> Vec;
   
       PubSubCommunicationFailureEventType(void);
       PubSubCommunicationFailureEventType(const PubSubCommunicationFailureEventType& value);
       virtual ~PubSubCommunicationFailureEventType(void);
        ...
        // Status
        //
        void error_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& error_Variable(void);
        bool get_Error_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_Error_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr error_Variable_;
