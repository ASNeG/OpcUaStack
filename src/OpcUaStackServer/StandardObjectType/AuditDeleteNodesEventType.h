/*
    ObjectTypeClass: AuditDeleteNodesEventType
...
#ifndef __OpcUaStackServer_AuditDeleteNodesEventType_h__
#define __OpcUaStackServer_AuditDeleteNodesEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT AuditDeleteNodesEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<AuditDeleteNodesEventType> SPtr;
       typedef std::vector<AuditDeleteNodesEventType::SPtr> Vec;
   
       AuditDeleteNodesEventType(void);
       AuditDeleteNodesEventType(const AuditDeleteNodesEventType& value);
       virtual ~AuditDeleteNodesEventType(void);
        ...
        //
        // DeleteNodesItem (Array)
        //
        void nodesToDelete_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& nodesToDelete_Variable(void);
        bool get_NodesToDelete_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_NodesToDelete_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr nodesToDelete_Variable_;
