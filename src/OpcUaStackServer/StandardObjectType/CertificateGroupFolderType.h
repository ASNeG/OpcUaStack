   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~CertificateGroupFolderType(void);
        ...
        bool get_DefaultApplicationGroup_CertificateTypes_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultApplicationGroup_CertificateTypes_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultApplicationGroup_TrustList_LastUpdateTime_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultApplicationGroup_TrustList_LastUpdateTime_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultApplicationGroup_TrustList_OpenCount_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultApplicationGroup_TrustList_OpenCount_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultApplicationGroup_TrustList_Size_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultApplicationGroup_TrustList_Size_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultApplicationGroup_TrustList_UserWritable_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultApplicationGroup_TrustList_UserWritable_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultApplicationGroup_TrustList_Writable_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultApplicationGroup_TrustList_Writable_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultHttpsGroup_CertificateTypes_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultHttpsGroup_CertificateTypes_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultHttpsGroup_TrustList_LastUpdateTime_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultHttpsGroup_TrustList_LastUpdateTime_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultHttpsGroup_TrustList_OpenCount_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultHttpsGroup_TrustList_OpenCount_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultHttpsGroup_TrustList_Size_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultHttpsGroup_TrustList_Size_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultHttpsGroup_TrustList_UserWritable_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultHttpsGroup_TrustList_UserWritable_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultHttpsGroup_TrustList_Writable_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultHttpsGroup_TrustList_Writable_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultUserTokenGroup_CertificateTypes_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultUserTokenGroup_CertificateTypes_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultUserTokenGroup_TrustList_LastUpdateTime_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultUserTokenGroup_TrustList_LastUpdateTime_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultUserTokenGroup_TrustList_OpenCount_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultUserTokenGroup_TrustList_OpenCount_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultUserTokenGroup_TrustList_Size_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultUserTokenGroup_TrustList_Size_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultUserTokenGroup_TrustList_UserWritable_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultUserTokenGroup_TrustList_UserWritable_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_DefaultUserTokenGroup_TrustList_Writable_Variable(OpcUaDataValue& dataValue);
        bool set_DefaultUserTokenGroup_TrustList_Writable_Variable(const OpcUaDataValue& dataValue);

        virtual void call_DefaultApplicationGroup_TrustList_Close_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultApplicationGroup_TrustList_GetPosition_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultApplicationGroup_TrustList_OpenWithMasks_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultApplicationGroup_TrustList_Open_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultApplicationGroup_TrustList_Read_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultApplicationGroup_TrustList_SetPosition_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultApplicationGroup_TrustList_Write_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultHttpsGroup_TrustList_Close_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultHttpsGroup_TrustList_GetPosition_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultHttpsGroup_TrustList_OpenWithMasks_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultHttpsGroup_TrustList_Open_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultHttpsGroup_TrustList_Read_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultHttpsGroup_TrustList_SetPosition_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultHttpsGroup_TrustList_Write_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultUserTokenGroup_TrustList_Close_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultUserTokenGroup_TrustList_GetPosition_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultUserTokenGroup_TrustList_OpenWithMasks_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultUserTokenGroup_TrustList_Open_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultUserTokenGroup_TrustList_Read_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultUserTokenGroup_TrustList_SetPosition_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_DefaultUserTokenGroup_TrustList_Write_Method(ApplicationMethodContext* applicationMethodContext);
