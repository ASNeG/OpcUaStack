/*
    ObjectTypeClass: AuditAddNodesEventType
...
#ifndef __OpcUaStackServer_AuditAddNodesEventType_h__
#define __OpcUaStackServer_AuditAddNodesEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT AuditAddNodesEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<AuditAddNodesEventType> SPtr;
       typedef std::vector<AuditAddNodesEventType::SPtr> Vec;
   
       AuditAddNodesEventType(void);
       AuditAddNodesEventType(const AuditAddNodesEventType& value);
       virtual ~AuditAddNodesEventType(void);
        ...
        // AddNodesItem (Array)
        //
        void nodesToAdd_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& nodesToAdd_Variable(void);
        bool get_NodesToAdd_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_NodesToAdd_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr nodesToAdd_Variable_;
