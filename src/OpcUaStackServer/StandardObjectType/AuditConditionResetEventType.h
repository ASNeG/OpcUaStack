/*
    ObjectTypeClass: AuditConditionResetEventType
...
#ifndef __OpcUaStackServer_AuditConditionResetEventType_h__
#define __OpcUaStackServer_AuditConditionResetEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT AuditConditionResetEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<AuditConditionResetEventType> SPtr;
       typedef std::vector<AuditConditionResetEventType::SPtr> Vec;
   
       AuditConditionResetEventType(void);
       AuditConditionResetEventType(const AuditConditionResetEventType& value);
       virtual ~AuditConditionResetEventType(void);
