   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~AuditOpenSecureChannelEventType(void);
        ...
        bool get_RequestType_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_RequestType_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_RequestedLifetime_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_RequestedLifetime_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
