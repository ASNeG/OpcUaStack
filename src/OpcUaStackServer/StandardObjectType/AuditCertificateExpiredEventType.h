/*
    ObjectTypeClass: AuditCertificateExpiredEventType
...
#ifndef __OpcUaStackServer_AuditCertificateExpiredEventType_h__
#define __OpcUaStackServer_AuditCertificateExpiredEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditCertificateExpiredEventType::SPtr> Vec;
   
       AuditCertificateExpiredEventType(void);
       AuditCertificateExpiredEventType(const AuditCertificateExpiredEventType& value);
