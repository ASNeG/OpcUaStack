/*
    ObjectTypeClass: KeyCredentialUpdatedAuditEventType
...
#ifndef __OpcUaStackServer_KeyCredentialUpdatedAuditEventType_h__
#define __OpcUaStackServer_KeyCredentialUpdatedAuditEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT KeyCredentialUpdatedAuditEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<KeyCredentialUpdatedAuditEventType> SPtr;
       typedef std::vector<KeyCredentialUpdatedAuditEventType::SPtr> Vec;
   
       KeyCredentialUpdatedAuditEventType(void);
       KeyCredentialUpdatedAuditEventType(const KeyCredentialUpdatedAuditEventType& value);
       virtual ~KeyCredentialUpdatedAuditEventType(void);
