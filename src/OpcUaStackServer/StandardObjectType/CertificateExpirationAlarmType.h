   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~CertificateExpirationAlarmType(void);
        ...
        bool get_CertificateType_Variable(OpcUaDataValue& dataValue);
        bool set_CertificateType_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_ExpirationDate_Variable(OpcUaDataValue& dataValue);
        bool set_ExpirationDate_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_ExpirationLimit_Variable(OpcUaDataValue& dataValue);
        bool set_ExpirationLimit_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_NormalState_Variable(OpcUaDataValue& dataValue);
        bool set_NormalState_Variable(const OpcUaDataValue& dataValue);
