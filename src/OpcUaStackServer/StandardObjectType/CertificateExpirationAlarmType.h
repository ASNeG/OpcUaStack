/*
    ObjectTypeClass: CertificateExpirationAlarmType
...
#ifndef __OpcUaStackServer_CertificateExpirationAlarmType_h__
#define __OpcUaStackServer_CertificateExpirationAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT CertificateExpirationAlarmType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<CertificateExpirationAlarmType> SPtr;
       typedef std::vector<CertificateExpirationAlarmType::SPtr> Vec;
   
       CertificateExpirationAlarmType(void);
       CertificateExpirationAlarmType(const CertificateExpirationAlarmType& value);
       virtual ~CertificateExpirationAlarmType(void);
        ...
        // NodeId
        //
        void certificateType_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& certificateType_Variable(void);
        bool get_CertificateType_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_CertificateType_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        // DateTime
        //
        void expirationDate_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& expirationDate_Variable(void);
        bool get_ExpirationDate_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ExpirationDate_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);

        //
        // Duration
        //
        void expirationLimit_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& expirationLimit_Variable(void);
        bool get_ExpirationLimit_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ExpirationLimit_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        // NodeId
        //
        void normalState_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& normalState_Variable(void);
        bool get_NormalState_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_NormalState_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr certificateType_Variable_;
        ...
        ServerVariable::SPtr expirationDate_Variable_;
        ServerVariable::SPtr expirationLimit_Variable_;
        ...
        ServerVariable::SPtr normalState_Variable_;
