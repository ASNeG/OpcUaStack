/*
    ObjectTypeClass: InstrumentDiagnosticAlarmType
...
#ifndef __OpcUaStackServer_InstrumentDiagnosticAlarmType_h__
#define __OpcUaStackServer_InstrumentDiagnosticAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT InstrumentDiagnosticAlarmType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<InstrumentDiagnosticAlarmType> SPtr;
       typedef std::vector<InstrumentDiagnosticAlarmType::SPtr> Vec;
   
       InstrumentDiagnosticAlarmType(void);
       InstrumentDiagnosticAlarmType(const InstrumentDiagnosticAlarmType& value);
       virtual ~InstrumentDiagnosticAlarmType(void);
