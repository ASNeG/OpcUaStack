/*
    ObjectTypeClass: AuditConditionShelvingEventType
...
#ifndef __OpcUaStackServer_AuditConditionShelvingEventType_h__
#define __OpcUaStackServer_AuditConditionShelvingEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditConditionShelvingEventType::SPtr> Vec;
   
       AuditConditionShelvingEventType(void);
       AuditConditionShelvingEventType(const AuditConditionShelvingEventType& value);
       virtual ~AuditConditionShelvingEventType(void);
        ...
        // Duration
        //
        void shelvingTime_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& shelvingTime_Variable(void);
        bool get_ShelvingTime_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ShelvingTime_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr shelvingTime_Variable_;
