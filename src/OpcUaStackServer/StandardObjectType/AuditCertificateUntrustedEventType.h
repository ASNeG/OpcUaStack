/*
    ObjectTypeClass: AuditCertificateUntrustedEventType
...
#ifndef __OpcUaStackServer_AuditCertificateUntrustedEventType_h__
#define __OpcUaStackServer_AuditCertificateUntrustedEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditCertificateUntrustedEventType::SPtr> Vec;
   
       AuditCertificateUntrustedEventType(void);
       AuditCertificateUntrustedEventType(const AuditCertificateUntrustedEventType& value);
