/*
    ObjectTypeClass: AuditConditionEventType
...
#ifndef __OpcUaStackServer_AuditConditionEventType_h__
#define __OpcUaStackServer_AuditConditionEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditConditionEventType::SPtr> Vec;
   
       AuditConditionEventType(void);
       AuditConditionEventType(const AuditConditionEventType& value);
