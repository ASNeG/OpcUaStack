   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~DiscrepancyAlarmType(void);
        ...
        bool get_ExpectedTime_Variable(OpcUaDataValue& dataValue);
        bool set_ExpectedTime_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_TargetValueNode_Variable(OpcUaDataValue& dataValue);
        bool set_TargetValueNode_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_Tolerance_Variable(OpcUaDataValue& dataValue);
        bool set_Tolerance_Variable(const OpcUaDataValue& dataValue);
