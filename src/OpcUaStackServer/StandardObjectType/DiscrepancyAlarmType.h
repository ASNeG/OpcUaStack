/*
    ObjectTypeClass: DiscrepancyAlarmType
...
#ifndef __OpcUaStackServer_DiscrepancyAlarmType_h__
#define __OpcUaStackServer_DiscrepancyAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT DiscrepancyAlarmType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<DiscrepancyAlarmType> SPtr;
       typedef std::vector<DiscrepancyAlarmType::SPtr> Vec;
   
       DiscrepancyAlarmType(void);
       DiscrepancyAlarmType(const DiscrepancyAlarmType& value);
       virtual ~DiscrepancyAlarmType(void);
        ...
        // Duration
        //
        void expectedTime_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& expectedTime_Variable(void);
        bool get_ExpectedTime_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ExpectedTime_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        // NodeId
        //
        void targetValueNode_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& targetValueNode_Variable(void);
        bool get_TargetValueNode_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_TargetValueNode_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        // Double
        //
        void tolerance_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& tolerance_Variable(void);
        bool get_Tolerance_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_Tolerance_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr expectedTime_Variable_;
        ...
        ServerVariable::SPtr targetValueNode_Variable_;
        ServerVariable::SPtr time_Variable_;
        ServerVariable::SPtr tolerance_Variable_;
