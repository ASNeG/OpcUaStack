/*
    ObjectTypeClass: AuditCertificateEventType
...
#ifndef __OpcUaStackServer_AuditCertificateEventType_h__
#define __OpcUaStackServer_AuditCertificateEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditCertificateEventType::SPtr> Vec;
   
       AuditCertificateEventType(void);
       AuditCertificateEventType(const AuditCertificateEventType& value);
