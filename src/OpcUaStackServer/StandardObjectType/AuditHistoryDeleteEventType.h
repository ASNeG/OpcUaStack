/*
    ObjectTypeClass: AuditHistoryDeleteEventType
...
#ifndef __OpcUaStackServer_AuditHistoryDeleteEventType_h__
#define __OpcUaStackServer_AuditHistoryDeleteEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditHistoryDeleteEventType::SPtr> Vec;
   
       AuditHistoryDeleteEventType(void);
       AuditHistoryDeleteEventType(const AuditHistoryDeleteEventType& value);
