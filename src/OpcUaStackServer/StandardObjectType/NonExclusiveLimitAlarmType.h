/*
    ObjectTypeClass: NonExclusiveLimitAlarmType
...
#ifndef __OpcUaStackServer_NonExclusiveLimitAlarmType_h__
#define __OpcUaStackServer_NonExclusiveLimitAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<NonExclusiveLimitAlarmType::SPtr> Vec;
   
       NonExclusiveLimitAlarmType(void);
       NonExclusiveLimitAlarmType(const NonExclusiveLimitAlarmType& value);
