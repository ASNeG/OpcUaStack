/*
    ObjectTypeClass: SemanticChangeEventType
...
#ifndef __OpcUaStackServer_SemanticChangeEventType_h__
#define __OpcUaStackServer_SemanticChangeEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT SemanticChangeEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<SemanticChangeEventType> SPtr;
       typedef std::vector<SemanticChangeEventType::SPtr> Vec;
   
       SemanticChangeEventType(void);
       SemanticChangeEventType(const SemanticChangeEventType& value);
       virtual ~SemanticChangeEventType(void);

        //
        // SemanticChangeStructureDataType (Array)
        //
