/*
    ObjectTypeClass: AuditConditionConfirmEventType
...
#ifndef __OpcUaStackServer_AuditConditionConfirmEventType_h__
#define __OpcUaStackServer_AuditConditionConfirmEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditConditionConfirmEventType::SPtr> Vec;
   
       AuditConditionConfirmEventType(void);
       AuditConditionConfirmEventType(const AuditConditionConfirmEventType& value);
