/*
    ObjectTypeClass: AuditConditionSuppressEventType
...
#ifndef __OpcUaStackServer_AuditConditionSuppressEventType_h__
#define __OpcUaStackServer_AuditConditionSuppressEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT AuditConditionSuppressEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<AuditConditionSuppressEventType> SPtr;
       typedef std::vector<AuditConditionSuppressEventType::SPtr> Vec;
   
       AuditConditionSuppressEventType(void);
       AuditConditionSuppressEventType(const AuditConditionSuppressEventType& value);
       virtual ~AuditConditionSuppressEventType(void);
