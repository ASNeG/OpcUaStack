/*
    ObjectTypeClass: TrustListUpdatedAuditEventType
...
#ifndef __OpcUaStackServer_TrustListUpdatedAuditEventType_h__
#define __OpcUaStackServer_TrustListUpdatedAuditEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT TrustListUpdatedAuditEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<TrustListUpdatedAuditEventType> SPtr;
       typedef std::vector<TrustListUpdatedAuditEventType::SPtr> Vec;
   
       TrustListUpdatedAuditEventType(void);
       TrustListUpdatedAuditEventType(const TrustListUpdatedAuditEventType& value);
       virtual ~TrustListUpdatedAuditEventType(void);
