   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~ServerConfigurationType(void);
        ...
        bool get_CertificateGroups_DefaultApplicationGroup_CertificateTypes_Variable(OpcUaDataValue& dataValue);
        bool set_CertificateGroups_DefaultApplicationGroup_CertificateTypes_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_CertificateGroups_DefaultApplicationGroup_TrustList_LastUpdateTime_Variable(OpcUaDataValue& dataValue);
        bool set_CertificateGroups_DefaultApplicationGroup_TrustList_LastUpdateTime_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_CertificateGroups_DefaultApplicationGroup_TrustList_OpenCount_Variable(OpcUaDataValue& dataValue);
        bool set_CertificateGroups_DefaultApplicationGroup_TrustList_OpenCount_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_CertificateGroups_DefaultApplicationGroup_TrustList_Size_Variable(OpcUaDataValue& dataValue);
        bool set_CertificateGroups_DefaultApplicationGroup_TrustList_Size_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_CertificateGroups_DefaultApplicationGroup_TrustList_UserWritable_Variable(OpcUaDataValue& dataValue);
        bool set_CertificateGroups_DefaultApplicationGroup_TrustList_UserWritable_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_CertificateGroups_DefaultApplicationGroup_TrustList_Writable_Variable(OpcUaDataValue& dataValue);
        bool set_CertificateGroups_DefaultApplicationGroup_TrustList_Writable_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_MaxTrustListSize_Variable(OpcUaDataValue& dataValue);
        bool set_MaxTrustListSize_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_MulticastDnsEnabled_Variable(OpcUaDataValue& dataValue);
        bool set_MulticastDnsEnabled_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_ServerCapabilities_Variable(OpcUaDataValue& dataValue);
        bool set_ServerCapabilities_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_SupportedPrivateKeyFormats_Variable(OpcUaDataValue& dataValue);
        bool set_SupportedPrivateKeyFormats_Variable(const OpcUaDataValue& dataValue);

        virtual void call_ApplyChanges_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_CertificateGroups_DefaultApplicationGroup_TrustList_Close_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_CertificateGroups_DefaultApplicationGroup_TrustList_GetPosition_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_CertificateGroups_DefaultApplicationGroup_TrustList_OpenWithMasks_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_CertificateGroups_DefaultApplicationGroup_TrustList_Open_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_CertificateGroups_DefaultApplicationGroup_TrustList_Read_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_CertificateGroups_DefaultApplicationGroup_TrustList_SetPosition_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_CertificateGroups_DefaultApplicationGroup_TrustList_Write_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_CreateSigningRequest_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_GetRejectedList_Method(ApplicationMethodContext* applicationMethodContext);

        virtual void call_UpdateCertificate_Method(ApplicationMethodContext* applicationMethodContext);
