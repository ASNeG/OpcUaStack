   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~UadpDataSetReaderMessageType(void);
        ...
        bool get_ProcessingOffset_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ProcessingOffset_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_ReceiveOffset_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ReceiveOffset_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
