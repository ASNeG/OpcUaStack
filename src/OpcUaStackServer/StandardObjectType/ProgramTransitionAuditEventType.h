/*
    ObjectTypeClass: ProgramTransitionAuditEventType
...
#ifndef __OpcUaStackServer_ProgramTransitionAuditEventType_h__
#define __OpcUaStackServer_ProgramTransitionAuditEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<ProgramTransitionAuditEventType::SPtr> Vec;
   
       ProgramTransitionAuditEventType(void);
       ProgramTransitionAuditEventType(const ProgramTransitionAuditEventType& value);
       virtual ~ProgramTransitionAuditEventType(void);
        ...
        // Variant
        //
        void newStateId_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& newStateId_Variable(void);
        bool get_NewStateId_Variable(OpcUaDataValue& dataValue);
        bool set_NewStateId_Variable(const OpcUaDataValue& dataValue);

        //
        // Variant
        //
        void oldStateId_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& oldStateId_Variable(void);
        bool get_OldStateId_Variable(OpcUaDataValue& dataValue);
        bool set_OldStateId_Variable(const OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr newStateId_Variable_;
        ServerVariable::SPtr oldStateId_Variable_;
