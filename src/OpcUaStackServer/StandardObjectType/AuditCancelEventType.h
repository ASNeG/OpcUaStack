/*
    ObjectTypeClass: AuditCancelEventType
...
#ifndef __OpcUaStackServer_AuditCancelEventType_h__
#define __OpcUaStackServer_AuditCancelEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditCancelEventType::SPtr> Vec;
   
       AuditCancelEventType(void);
       AuditCancelEventType(const AuditCancelEventType& value);
       virtual ~AuditCancelEventType(void);
        ...
        // UInt32
        //
        void requestHandle_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& requestHandle_Variable(void);
        bool get_RequestHandle_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_RequestHandle_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr requestHandle_Variable_;
