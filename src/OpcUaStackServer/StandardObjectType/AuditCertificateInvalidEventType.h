/*
    ObjectTypeClass: AuditCertificateInvalidEventType
...
#ifndef __OpcUaStackServer_AuditCertificateInvalidEventType_h__
#define __OpcUaStackServer_AuditCertificateInvalidEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditCertificateInvalidEventType::SPtr> Vec;
   
       AuditCertificateInvalidEventType(void);
       AuditCertificateInvalidEventType(const AuditCertificateInvalidEventType& value);
