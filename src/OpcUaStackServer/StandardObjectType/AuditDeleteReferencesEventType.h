/*
    ObjectTypeClass: AuditDeleteReferencesEventType
...
#ifndef __OpcUaStackServer_AuditDeleteReferencesEventType_h__
#define __OpcUaStackServer_AuditDeleteReferencesEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT AuditDeleteReferencesEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<AuditDeleteReferencesEventType> SPtr;
       typedef std::vector<AuditDeleteReferencesEventType::SPtr> Vec;
   
       AuditDeleteReferencesEventType(void);
       AuditDeleteReferencesEventType(const AuditDeleteReferencesEventType& value);
       virtual ~AuditDeleteReferencesEventType(void);
        ...
        //
        // DeleteReferencesItem (Array)
        //
        void referencesToDelete_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& referencesToDelete_Variable(void);
        bool get_ReferencesToDelete_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ReferencesToDelete_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr referencesToDelete_Variable_;
