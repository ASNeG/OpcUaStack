/*
    ObjectTypeClass: AuditHistoryRawModifyDeleteEventType
...
#ifndef __OpcUaStackServer_AuditHistoryRawModifyDeleteEventType_h__
#define __OpcUaStackServer_AuditHistoryRawModifyDeleteEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditHistoryRawModifyDeleteEventType::SPtr> Vec;
   
       AuditHistoryRawModifyDeleteEventType(void);
       AuditHistoryRawModifyDeleteEventType(const AuditHistoryRawModifyDeleteEventType& value);
       virtual ~AuditHistoryRawModifyDeleteEventType(void);
        ...
        // UtcTime
        //
        void endTime_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& endTime_Variable(void);
        bool get_EndTime_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_EndTime_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        // Boolean
        //
        void isDeleteModified_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& isDeleteModified_Variable(void);
        bool get_IsDeleteModified_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_IsDeleteModified_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ...
        ServerVariable::SPtr endTime_Variable_;
        ServerVariable::SPtr eventId_Variable_;
        ServerVariable::SPtr eventType_Variable_;
        ServerVariable::SPtr isDeleteModified_Variable_;
