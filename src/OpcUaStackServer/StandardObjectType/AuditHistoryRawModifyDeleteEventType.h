   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~AuditHistoryRawModifyDeleteEventType(void);
        ...
        bool get_EndTime_Variable(OpcUaDataValue& dataValue);
        bool set_EndTime_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_IsDeleteModified_Variable(OpcUaDataValue& dataValue);
        bool set_IsDeleteModified_Variable(const OpcUaDataValue& dataValue);
