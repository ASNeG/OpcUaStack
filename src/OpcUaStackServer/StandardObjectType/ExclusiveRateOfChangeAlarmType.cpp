...
namespace OpcUaStackServer
{
    ...
    , unsuppress_Method_(boost::make_shared<ServerMethod>("Unsuppress_Method"))
    {
        ...
        acknowledge_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_Acknowledge_Method, this, boost::placeholders::_1));
        addComment_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_AddComment_Method, this, boost::placeholders::_1));
        confirm_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_Confirm_Method, this, boost::placeholders::_1));
        disable_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_Disable_Method, this, boost::placeholders::_1));
        enable_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_Enable_Method, this, boost::placeholders::_1));
        placeInService_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_PlaceInService_Method, this, boost::placeholders::_1));
        removeFromService_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_RemoveFromService_Method, this, boost::placeholders::_1));
        reset_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_Reset_Method, this, boost::placeholders::_1));
        shelvingState_OneShotShelve_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_ShelvingState_OneShotShelve_Method, this, boost::placeholders::_1));
        shelvingState_TimedShelve_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_ShelvingState_TimedShelve_Method, this, boost::placeholders::_1));
        shelvingState_Unshelve_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_ShelvingState_Unshelve_Method, this, boost::placeholders::_1));
        silence_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_Silence_Method, this, boost::placeholders::_1));
        suppress_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_Suppress_Method, this, boost::placeholders::_1));
        unsuppress_Method_->registerMethod(boost::bind(&ExclusiveRateOfChangeAlarmType::call_Unsuppress_Method, this, boost::placeholders::_1));
    }
