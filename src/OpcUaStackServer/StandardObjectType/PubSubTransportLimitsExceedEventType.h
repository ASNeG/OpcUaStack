/*
    ObjectTypeClass: PubSubTransportLimitsExceedEventType
...
#ifndef __OpcUaStackServer_PubSubTransportLimitsExceedEventType_h__
#define __OpcUaStackServer_PubSubTransportLimitsExceedEventType_h__
...
namespace OpcUaStackServer
{
   ...
   class DLLEXPORT PubSubTransportLimitsExceedEventType
   : public ObjectBase
   {
     public:
       typedef boost::shared_ptr<PubSubTransportLimitsExceedEventType> SPtr;
       typedef std::vector<PubSubTransportLimitsExceedEventType::SPtr> Vec;
   
       PubSubTransportLimitsExceedEventType(void);
       PubSubTransportLimitsExceedEventType(const PubSubTransportLimitsExceedEventType& value);
       virtual ~PubSubTransportLimitsExceedEventType(void);

        //
        // UInt32
        //
        void actual_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& actual_Variable(void);
        bool get_Actual_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_Actual_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_ConnectionId_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_ConnectionId_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        bool get_GroupId_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_GroupId_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
        ...
        // UInt32
        //
        void maximum_Variable(ServerVariable::SPtr& serverVariable);
        ServerVariable::SPtr& maximum_Variable(void);
        bool get_Maximum_Variable(OpcUaStackCore::OpcUaDataValue& dataValue);
        bool set_Maximum_Variable(const OpcUaStackCore::OpcUaDataValue& dataValue);
      ...
      private:
        ServerVariable::SPtr actual_Variable_;
        ...
        ServerVariable::SPtr maximum_Variable_;
