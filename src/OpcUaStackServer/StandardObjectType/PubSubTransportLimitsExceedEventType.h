   ...
   : public ObjectBase
   {
     public:
       ...
       virtual ~PubSubTransportLimitsExceedEventType(void);
        ...
        bool get_Actual_Variable(OpcUaDataValue& dataValue);
        bool set_Actual_Variable(const OpcUaDataValue& dataValue);
        ...
        bool get_Maximum_Variable(OpcUaDataValue& dataValue);
        bool set_Maximum_Variable(const OpcUaDataValue& dataValue);
