/*
    ObjectTypeClass: NonExclusiveRateOfChangeAlarmType
...
#ifndef __OpcUaStackServer_NonExclusiveRateOfChangeAlarmType_h__
#define __OpcUaStackServer_NonExclusiveRateOfChangeAlarmType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<NonExclusiveRateOfChangeAlarmType::SPtr> Vec;
   
       NonExclusiveRateOfChangeAlarmType(void);
       NonExclusiveRateOfChangeAlarmType(const NonExclusiveRateOfChangeAlarmType& value);
