/*
    ObjectTypeClass: AuditCertificateMismatchEventType
...
#ifndef __OpcUaStackServer_AuditCertificateMismatchEventType_h__
#define __OpcUaStackServer_AuditCertificateMismatchEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditCertificateMismatchEventType::SPtr> Vec;
   
       AuditCertificateMismatchEventType(void);
       AuditCertificateMismatchEventType(const AuditCertificateMismatchEventType& value);
