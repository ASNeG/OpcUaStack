/*
    ObjectTypeClass: AuditNodeManagementEventType
...
#ifndef __OpcUaStackServer_AuditNodeManagementEventType_h__
#define __OpcUaStackServer_AuditNodeManagementEventType_h__
...
namespace OpcUaStackServer
{
   ...
   : public ObjectBase
   {
     public:
       ...
       typedef std::vector<AuditNodeManagementEventType::SPtr> Vec;
   
       AuditNodeManagementEventType(void);
       AuditNodeManagementEventType(const AuditNodeManagementEventType& value);
