...
#ifndef __OpcUaClient_ClientServiceWrite_h__
#define __OpcUaClient_ClientServiceWrite_h__
...
namespace OpcUaClient
{
	...
	class DLLEXPORT ClientServiceWrite
	: public ClientServiceBase
	{
	  public:
		typedef boost::shared_ptr<ClientServiceWrite> SPtr;

		ClientServiceWrite(void);
		virtual ~ClientServiceWrite(void);

		//- ClientServiceWrite interface ---------------------------------------
