...
#ifndef __OpcUaCtrl_ApplCertCtrlCommand_h__
#define __OpcUaCtrl_ApplCertCtrlCommand_h__
...
namespace OpcUaCtrl
{
	...
	class DLLEXPORT ApplCertCtrlCommand
	: public CtrlCommand
	{
	  public:
		using SPtr = boost::shared_ptr<ApplCertCtrlCommand>;

		ApplCertCtrlCommand(void);
		virtual ~ApplCertCtrlCommand(void);
	  ...
	  private:
		...
		uint32_t get(const std::vector<std::string>& commandLine);
