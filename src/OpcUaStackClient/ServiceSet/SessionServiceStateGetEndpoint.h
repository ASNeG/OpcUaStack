 ...
 */
#ifndef __OpcUaStackClient_SessionServiceStateGetEndpoint_h__
#define __OpcUaStackClient_SessionServiceStateGetEndpoint_h__
...
namespace OpcUaStackClient
{
	...
	class DLLEXPORT SessionServiceStateGetEndpoint
	: public SessionServiceStateIf
	{
	  public:
		SessionServiceStateGetEndpoint(void);
		~SessionServiceStateGetEndpoint(void);
