 ...
 */
#ifndef __OpcUaStackClient_SessionServiceStateConnecting_h__
#define __OpcUaStackClient_SessionServiceStateConnecting_h__
...
namespace OpcUaStackClient
{
	...
	class DLLEXPORT SessionServiceStateConnecting
