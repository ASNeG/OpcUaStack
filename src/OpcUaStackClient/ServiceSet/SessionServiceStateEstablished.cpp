...
namespace OpcUaStackClient
{
	...
	SessionServiceStateId
	SessionServiceStateEstablished::handleEstablishedResponse(SecureChannel* secureChannel)
	{
		// FIXME: todo
		return SessionServiceStateId::Established;
	}
	...
	SessionServiceStateId
	SessionServiceStateEstablished::handleActivateSessionResponse(SecureChannel* secureChannel)
	{
		// FIXME: todo
		return SessionServiceStateId::Established;
	}
	...
	SessionServiceStateId
	SessionServiceStateEstablished::handleMessageResponse(SecureChannel* secureChannel)
	{
		// FIXME: todo
		return SessionServiceStateId::Established;
	}
	...
	SessionServiceStateId
	SessionServiceStateEstablished::receive(Message::SPtr message)
	{
		// FIXME: todo
		return SessionServiceStateId::Established;
	}
	...
	SessionServiceStateId
	SessionServiceStateEstablished::pendingQueueTimeout(void)
	{
		// FIXME: todo
		return SessionServiceStateId::Established;
	}
