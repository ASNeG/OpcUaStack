...
#ifndef __OpcUaStackPubSub_MsgTransProvider_h__
#define __OpcUaStackPubSub_MsgTransProvider_h__
...
namespace OpcUaStackPubSub
{
	...
	class DLLEXPORT MsgTransProvider
	: public OpcUaStackCore::Object
	, public OpcUaStackServer::ServerServiceBase
	{
	  public:
		using SPtr = boost::shared_ptr<MsgTransProvider>;
