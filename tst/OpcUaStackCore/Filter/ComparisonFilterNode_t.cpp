...
BOOST_AUTO_TEST_CASE(ComparisonFilterNode_120_greater_than_100)
{
    ...
    ComparisonFilterNode greaterThanOperator(FilterOperator::EnumGreaterThan, args);
...
BOOST_AUTO_TEST_CASE(ComparisonFilterNode_100_less_than_120)
{
    ...
    ComparisonFilterNode lessThanOperator(FilterOperator::EnumLessThan, args);
...
BOOST_AUTO_TEST_CASE(ComparisonFilterNode_120_greater_than_or_equal_100)
{
    ...
    ComparisonFilterNode greaterThanOrEqualOperator(FilterOperator::EnumGreaterThanOrEqual, args);
