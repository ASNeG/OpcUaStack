...
{
	boost::posix_time::ptime validTimeNotBefore(boost::posix_time::time_from_string("2016-01-01 00:00:00"));
	boost::posix_time::ptime validTimeNotAfter(boost::posix_time::time_from_string("2021-01-01 00:00:00"));
}
