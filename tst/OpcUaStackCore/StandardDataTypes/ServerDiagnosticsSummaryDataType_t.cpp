...
BOOST_AUTO_TEST_CASE(ServerDiagnosticsSummaryDataType_encode_decode)
{
	...
	BOOST_REQUIRE(value2.samplingRateCount() == 8);
...
BOOST_AUTO_TEST_CASE(ServerDiagnosticsSummaryDataType_ExtensionObject)
{
	...
	value1.parameter<ServerDiagnosticsSummaryDataType>()->samplingRateCount(8);
	...
	BOOST_REQUIRE(value2.parameter<ServerDiagnosticsSummaryDataType>()->samplingRateCount() == 8);
