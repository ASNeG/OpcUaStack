...
BOOST_AUTO_TEST_CASE(SubscriptionDiagnosticsDataType_encode_decode)
{
	...
	BOOST_REQUIRE(value2.modifyCount() == 7);
...
BOOST_AUTO_TEST_CASE(SubscriptionDiagnosticsDataType_ExtensionObject)
{
	...
	value1.parameter<SubscriptionDiagnosticsDataType>()->modifyCount() = 7;
	...
	BOOST_REQUIRE(value2.parameter<SubscriptionDiagnosticsDataType>()->modifyCount() == 7);
