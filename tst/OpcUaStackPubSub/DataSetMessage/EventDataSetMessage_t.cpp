...
BOOST_AUTO_TEST_SUITE(EventDataSetMessage_)

BOOST_AUTO_TEST_CASE(EventDataSetMessage_)
{
	std::cout << "EventDataSetMessage_t" << std::endl;
}

BOOST_AUTO_TEST_CASE(EventDataSetMessage_encode_decode_variant)
{
	EventDataSetMessage value1, value2;
